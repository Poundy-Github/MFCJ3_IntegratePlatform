...
TRESOS2_PROJECT_NAME := BootLoaderUpdater
...
PROJECT_MODULES := Atomics BLUpdater Base CanIf CanSM Can ComM Compiler Det EcuC Flash I2c Make McalLib Mcu MemMap PduR Platforms Port Resource
else
...
BLUpdater_VARIANT   := TS_TxDxM1I3R0
BLUpdater_CORE_PATH := $(TRESOS_BASE)/plugins/BLUpdater_TS_TxDxM1I3R0
...
Can_VARIANT   := TS_T16D27M10I30R0
Can_CORE_PATH := $(TRESOS_BASE)/plugins/Can_TS_T16D27M10I30R0
...
Flash_VARIANT   := TS_T16D27M7I1R0
Flash_CORE_PATH := $(TRESOS_BASE)/plugins/Flash_TS_T16D27M7I1R0
I2c_VARIANT   := TS_T16D27M10I30R0
I2c_CORE_PATH := $(TRESOS_BASE)/plugins/I2c_TS_T16D27M10I30R0
...
Port_VARIANT   := TS_T16D27M10I30R0
Port_CORE_PATH := $(TRESOS_BASE)/plugins/Port_TS_T16D27M10I30R0
