 ...
 */
#if (!defined PDUR_BLUPDATER_H)
#define PDUR_BLUPDATER_H
...
/** \brief This function is called by BLUpdater module to request transmission of an I-PDU.
 **
 ...
 **/
extern FUNC(Std_ReturnType, PDUR_CODE) PduR_BLUpdaterTransmit
(
    PduIdType TxPduId,
...
#endif /* if !defined( PDUR_BLUPDATER_H ) */
/*==================[end of file]===========================================*/
