...
#define Com_gConfigPtr \
    ((P2CONST(Com_ConfigType, COM_VAR_NOINIT, COM_APPL_CONST)) \
...
#define COM_START_SEC_VAR_NO_INIT_8BIT
#include <Com_MemMap.h>

/** \brief Com_GlobalTime (8 bit)
 * time in COM specific ticks */
#if (COM_TIMEBASE == STD_ON)
extern VAR(ComGlobalTimeType, COM_VAR_NOINIT) Com_GlobalTime;
#else
extern VAR(ComGlobalTimeType_Tx, COM_VAR_NOINIT) Com_GlobalTimes_Tx;
extern VAR(ComGlobalTimeType_Rx, COM_VAR_NOINIT) Com_GlobalTimes_Rx;
#endif /* (COM_TIMEBASE == STD_ON) */

#define COM_STOP_SEC_VAR_NO_INIT_8BIT
#include <Com_MemMap.h>
...
#define COM_START_SEC_VAR_NO_INIT_16BIT
#include <Com_MemMap.h>
...
#define COM_STOP_SEC_VAR_NO_INIT_16BIT
#include <Com_MemMap.h>
...
#define COM_START_SEC_VAR_NO_INIT_32BIT
#include <Com_MemMap.h>
...
#define COM_STOP_SEC_VAR_NO_INIT_32BIT
#include <Com_MemMap.h>
 ...
 */
extern P2CONST(Com_ConfigType, COM_VAR_NOINIT, COM_APPL_CONST) Com_gConfigPtr;
/* CHECK: RULE 506 ON */
