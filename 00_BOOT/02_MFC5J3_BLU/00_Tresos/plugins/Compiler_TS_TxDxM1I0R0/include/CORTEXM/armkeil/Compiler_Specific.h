...
#if (defined _ARMKEIL_C_CORTEXM_) /* to prevent double definition */
#error _ARMKEIL_C_CORTEXM_ already defined
#endif /* if (defined _ARMKEIL_C_CORTEXM_) */

/** \brief compiler symbol for ARM compiler */
/* Deviation MISRAC2012-1 */
#define _ARMKEIL_C_CORTEXM_ 1U
