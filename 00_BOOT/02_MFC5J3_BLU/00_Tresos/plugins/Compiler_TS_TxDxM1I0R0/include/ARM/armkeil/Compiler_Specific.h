 ...
 * The macro _DIABDATA_C_PPC_ is only used for Autosar 2.1 backward compatibility.
 */
/* COMPILER010 */
/* !LINKSTO CompilerAbstraction.ASR403.COMPILER010, 1 */
#if (defined _ARMKEIL_C_ARM_) /* to prevent double definition */
#error _ARMKEIL_C_ARM_ already defined
#endif /* if (defined _ARMKEIL_C_ARM_) */

/** \brief compiler symbol for DiabData compiler for ARM */
/* Deviation MISRAC2012-1 */
#define _ARMKEIL_C_ARM_ 1U
