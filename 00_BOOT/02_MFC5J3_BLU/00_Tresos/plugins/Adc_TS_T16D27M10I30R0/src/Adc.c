...
/*[cover parentID={57675972-EF57-41f1-A663-665E62D0DD60}] Modules version 
consistency check [/cover]*/
#if ( ADC_SW_MAJOR_VERSION != 10U )
  #error "ADC_SW_MAJOR_VERSION does not match."
#endif

#if ( ADC_SW_MINOR_VERSION != 30U )
                                ...
                                const Adc_ValueGroupType * const DataBufferPtr)
{
  ...
  /* Check DET's for the API */
  lDetVal = Adc_lSetupResBufDetCheck(lKernelId,lGroupId,DataBufferPtr,lCoreId);
  ...
  /* [cover parentID={B69C2382-B69C-458a-8A13-33B353E3066D}]
  DET Error Occured [/cover] */
  if(ADC_E_NO_ERR != lDetVal)
  {
  ...
  #endif
  {
    ...
    DET is OFF and SAFETY is OFF [/cover] */
    #if ((ADC_DEV_ERROR_DETECT == STD_OFF) && (ADC_SAFETY_ENABLE == STD_OFF))
    ...
    Initialize the Result buffer pointer in the Kernel data pointer with buffer
    address passed [/cover] */
...
void Adc_DeInit(void)
{
  ...
  uint8 lDetVal;
  /* Check DET's for the API */
  lDetVal = Adc_lDeInitDetCheck(lCoreId);
...
void Adc_StartGroupConversion(const Adc_GroupType Group)
{
  ...
  /* Check DET's for the API */
  lDetVal = Adc_lStartGrpConvDetCheck(lKernelId, lGroupId, lCoreId);
  ...
  /* [cover parentID={DC058AAE-E4EF-4e42-9EF9-1425718D9CAC}]
  DET Error  [/cover] */
  if(ADC_E_NO_ERR == lDetVal)
  #endif
  {
...
void Adc_StopGroupConversion(const Adc_GroupType Group)
{
  ...
  /* Check DET's for the API */
  lDetVal = Adc_lStopGrpConvDetCheck(lKernelId, lGroupId, lCoreId);
  ...
  /* [cover parentID={D7A187BB-0D65-48db-B58F-F9B934FB9BE5}]
  DET Error [/cover] */
  if(ADC_E_NO_ERR == lDetVal)
  #endif
  {
                             ...
                             Adc_ValueGroupType * const DataBufferPtr)
{
  ...
  uint8 lDetVal;
  /* Check DET's for the API */
  lDetVal = Adc_lReadGrpDetCheck(DataBufferPtr, lKernelId, lGroupId, lCoreId);
  ...
  /* [cover parentID={9D97DE82-FB84-434c-AA25-49192D8FD700}]
  DET Error [/cover] */
  if(ADC_E_NO_ERR != lDetVal)
  {
  ...
  #endif
  {
    ...
    else
    {
      ...
      */
      ...
      /* [cover parentID={3A28A59E-4A9F-40a1-8A8A-30F78A12C71A}] Sync Conversion
      is ON [/cover] */
      #if (ADC_SYNC_CONV_ENABLE == STD_ON)
      ...
      Groups which are not converting - implicitly stopped are put to IDLE state
      & Reset the Number of valid conversion to ZERO   [/cover] */
...
void Adc_EnableHardwareTrigger(const Adc_GroupType Group)
{
  ...
  uint8 lDetVal;
  /* Check DET's for the API */
  lDetVal = Adc_lEnHwTriggerDetCheck(lKernelId, lGroupId, lCoreId);
  ...
  /* [cover parentID={9D5F194D-6067-4e75-9472-647F3CC29396}]
  DET Error  [/cover] */
  if(ADC_E_NO_ERR == lDetVal)
  #endif
  {
    ...
    Strat of Critical Section [/cover] */
    SchM_Enter_Adc_KernelData();
    #endif
    ...
    Update Active Group ID to the corresponding Request Source data [/cover] */
    lKernelDataPtr->RSData[lGrpCfgPtr->GrpPriority].ActiveGroupId = lGroupId;
    ...
    Prepare queue and Enable Hardware trigger peripheral conversion [/cover] */
...
void Adc_DisableHardwareTrigger(const Adc_GroupType Group)
{
  ...
  uint8 lDetVal;
  /* Check DET's for the API */
  lDetVal = Adc_lDisHwTriggerDetCheck(lKernelId, lGroupId, lCoreId);
  ...
  /* [cover parentID={6FEC7D69-AD01-42d6-8A8D-E337FE8F9106}]
  DET Error [/cover] */
  if(ADC_E_NO_ERR == lDetVal)
  #endif
  {
       ...
       const Adc_GroupType Group,  Adc_ValueGroupType ** const PtrToSamplePtr)
{
  ...
  uint8 lDetVal;
  /* Check DET's for the API */
  lDetVal = Adc_lGetStrmPtrDetCheck(lKernelId, lGroupId,PtrToSamplePtr,lCoreId);
  /* [cover parentID={8261AD0B-B4C8-4a0c-AF95-1E0E5E4D294C}]
  Stream Pointer DET Error [/cover] */
  if(ADC_E_NO_ERR == lDetVal)
  {
  ...
  /* [cover parentID={B3A97537-5C6E-49a8-A4B2-E4F0CF818651}]
  DET Error  [/cover] */
  if(ADC_E_NO_ERR != lDetVal)
  {
    ...
    else
    {
      ...
      *PtrToSamplePtr = &((lKernelDataPtr->GrpResBuffer[lGroupId])\
      ...
      if(lStrmCompletedFlag == (uint32)ADC_ONE_U)
      {
        ...
        No of Valid conversions are equal to No of configured Samples [/cover]*/
...
Std_ReturnType Adc_SetPowerState(Adc_PowerStateRequestResultType * const Result)
{
  ...
  uint8 lDetVal;
  /* Check DET's for the API */
  lDetVal = Adc_lSetPowerStateDetCheck(Result, lCoreId, lTargetPwrState);
                                   ...
                                   const uint8 ReqSrc)
{
  ...
  while(lChloopCount < (lNoOfChannels - (uint8)1U))
  {
    ...
    Anlaong channels are pushed to RS queue with refill mode information
    [/cover] */
  ...
  Last Anlaong channels is  pushed to RS queue with refill mode information
  and RS interrupt enabled [/cover] */
                                 ...
                                 const uint8 ReqSrc)
{
  ...
  if(lWaitCount != (uint32)0U)
  {
    ...
    Dem_ReportErrorStatus(ADC_E_CONV_STOP_TIME_FAILURE,DEM_EVENT_STATUS_PASSED);
  }
  else
  {
    ...
    Dem_ReportErrorStatus(ADC_E_CONV_STOP_TIME_FAILURE,DEM_EVENT_STATUS_FAILED);
  }
  #endif
  #endif
    ...
    if((lGrpCfgPtr[lLoopCount].TriggerSource) == ADC_TRIGG_SRC_HW)
    {
      ...
      if (lGrpCfgPtr[lLoopCount].GrpReqTmCfg == (uint32)0U)
      {
        ...
        if(lGrpCfgPtr[lLoopCount].GtmTrigCfg != NULL_PTR)
        {
          ...
          lGtmTomAtomChConfig.TimerChPortOutConfig = (uint32)0U;
                                         ...
                                         const uint8 ReqSrc)
{
  ...
  while(lChloopCount < (lNoOfChannels - (uint8)1U))
  {
    ...
    {B9568FC8-DC93-4299-A713-C3BA9A6E7A0D}] Anlaong channels are pushed to RS
    queue with refill mode information [/cover] */
  ...
  Last Anlaong channels is  pushed to RS queue with refill mode information and
  RS interrupt enabled [/cover] */
                                ...
                                const uint32 CoreId)
{
  ...
  if(lKernelDataPtr->RSData[RequestSrc].IsrNoServiceFlag == (uint8)0U)
  {
    ...
    #if (ADC_GRP_NOTIF_CAPABILITY == STD_ON)
    const Adc_GroupCfgType *lGrpCfgPtr;
    /* [cover parentID={2DEDFA3E-48DC-4f2c-AFB4-DBB2150DDD35}]
  ...
  if (MCAL_MASTER_COREID != CoreId)
  {
    ...
    #endif
    {
      ...
      if ((ConfigPtr == NULL_PTR) || (Adc_ConfigPtr != ConfigPtr))
      {
        ...
        Report ADC_E_PARAM_CONFIG DET  [/cover] */
        Adc_lReportError(ADC_SID_INIT, ADC_E_PARAM_CONFIG);
      }
...
LOCAL_INLINE uint8 Adc_lDeInitDetCheck(const uint32 CoreId)
{
  ...
  if(lErrVal == ADC_E_NO_ERR)
  {
    /* [cover parentID={5C6887D8-FCB8-4ee2-ADD5-3860CDE089D1}]
    Check Adc Group Busy DET [/cover] */
    lErrVal = Adc_lCheckGrpBusyDet((uint32)0U, (Adc_GroupType)0U, \
                                   ADC_SID_DEINIT, CoreId);
    ...
    uint32 lCore;
    if (lErrVal == ADC_E_NO_ERR)
      /* [cover parentID={35617632-734E-440d-9537-92BD2B750EC9}]
      Group Busy DET Error [/cover] */
    {
            ...
            const uint32 TargetPwrState)
{
  ...
  if(lErrVal == ADC_E_NO_ERR)
  {
    ...
    if(lErrVal == ADC_E_NO_ERR)
    {
      ...
      if(lErrVal == ADC_E_NO_ERR)
      {
        /* [cover parentID={A9EBE800-B321-4fbc-8212-B65427CCEA8C}]
        Check Hardware Unit DisEngaged DET [/cover] */
        lErrVal = Adc_lCheckHwUnitDisEngagedDet(ADC_SID_SET_POWER_STATE,CoreId);
        /* [cover parentID={7C4B68F0-8C89-4911-9DE0-99E0DBE6DCE9}]
        Is Hardware Unit DisEngaged Det error occured ? [/cover] */
        if(lErrVal != ADC_E_NO_ERR)
        {
          /* [cover parentID={27BAEB2B-C14A-4380-9A0D-BEBE71A096B4}]
        ...
        const Adc_GroupType GroupId, const uint8 ServiceId, const uint32 CoreId)
{
  ...
  MultiCore Error Detection on or DET on [/cover] */
  #if ((ADC_MULTICORE_ERROR_DETECT == STD_ON)||(ADC_SAFETY_ENABLE == STD_ON))
        ...
        const Adc_GroupType GroupId, const uint8 ServiceId, const uint32 CoreId)
{
  ...
  if( (lBusyFlag == (uint32)0U) && (lResultFlag == (uint32)0U) )
  {
    ...
    Report ADC_E_IDLE Det  [/cover] */
    Adc_lReportError(ServiceId, ADC_E_IDLE);
        ...
        const Adc_GroupType GroupId, const uint8 ServiceId, const uint32 CoreId)
{
  ...
  switch (ServiceId)
  {
    ...
    case ADC_SID_DEINIT:
    {
      ...
      {
        /* [cover parentID={FA014EE2-A8B3-47c5-A58D-325255680AF6}]
        Report ADC_E_BUSY DET [/cover] */
        Adc_lReportError(ADC_SID_DEINIT, ADC_E_BUSY);
        /* Update return value */
        lErrVal = ADC_E_BUSY;
      }
    }
    ...
    case ADC_SID_SETUP_RESULT_BUFFER:
    {
          ...
          (lResultFlag == (uint32)ADC_ONE_U))
      {
        ...
        Report ADC_E_BUSY DET [/cover] */
        Adc_lReportError(ADC_SID_SETUP_RESULT_BUFFER, ADC_E_BUSY);
        lErrVal = ADC_E_BUSY;
      }
    }
    break;
    ...
    case ADC_SID_START_GROUP_CONVERSION:
    {
      ...
      Check Start Group Conversion Busy DET [/cover] */
    ...
    case ADC_SID_ENABLE_HARDWARE_TRIGGER:
    {
      ...
      Check hardware trigger group busy DET [/cover] */
...
the ADC_E_BUSY DET for different mode of ADC operation (No priority, Queuing ,
HW priority & HW-SW priority) & Also ADC_E_BUSY DET for groups enabled with
Limit checking & Alias configurations. The different if conditions in different
operating mode causes the complexity to increase,but actually during run-time
out of all if conditions many will be pre-compile time removed */
/*******************************************************************************
...
**                                                                            **
** Description      :This function is to check ADC_E_BUSY DET for             **
**                   the ADC_SID_START_GROUP_CONVERSION service ID.           **
** [/cover]                                                                   **
** Service ID       : NA                                                      **
**                                                                            **
** Sync/Async       : Synchronous                                             **
  ...
  const uint32 CoreId)
{
  ...
  /*Raise Busy DET, if group is already in the queue or any channel/result
  ...
  #endif
  {
    ...
    Report ADC_E_BUSY DET & Update return value as ADC_E_BUSY [/cover] */
    Adc_lReportError(ADC_SID_START_GROUP_CONVERSION,ADC_E_BUSY);
    lErrVal = ADC_E_BUSY;
  }
  #if (ADC_PRIORITY_IMPLEMENTATION == ADC_PRIORITY_HW_SW)
  else
  {
    ...
    Report ADC_E_BUSY DET if no free RS and no lower priority SW group is
    executing [/cover] */
...
**                                                                            **
** Description      :This function is to check ADC_E_BUSY DET for             **
**                   the ADC_SID_ENABLE_HARDWARE_TRIGGER service ID.          **
** [/cover]                                                                   **
** Service ID       : NA                                                      **
**                                                                            **
** Sync/Async       : Synchronous                                             **
  ...
  const uint32 CoreId)
{
  ...
  #endif
  {
    ...
    Report ADC_E_BUSY DET & Update return value as ADC_E_BUSY [/cover] */
    Adc_lReportError(ADC_SID_ENABLE_HARDWARE_TRIGGER, ADC_E_BUSY);
    lErrVal = ADC_E_BUSY;
  }
  #if (ADC_PRIORITY_IMPLEMENTATION == ADC_PRIORITY_HW_SW)
  else
...
**                    )                                                       **
**                                                                            **
** Description      :This function is to check the ADC_E_BUSY DET for slave   **
**                   kernels of the synchronization master                    **
** [/cover]                                                                   **
** Service ID       : NA                                                      **
**                                                                            **
** Sync/Async       : Synchronous                                             **
       ...
       lKernelCount < (uint8)(ADC_KERNELS_PER_SYNGRP - 1U); lKernelCount++)
  {
    ...
    if (lSlaveKernel != ADC_INVALID_KERNEL_ID)
    {
           ...
           (uint16)0U))
      {
        ...
        Update error value as  ADC_E_BUSY & Report  DET [/cover] */
        Adc_lReportError(ApiId, ADC_E_BUSY);
        lErrVal = ADC_E_BUSY;
        break;
      }
    }
...
**                    )                                                       **
**                                                                            **
** Description      :This function is to check the ADC_E_BUSY DET for         **
**                   Adc_StartGroupConversion API with HW-SW priority         **
** [/cover]                                                                   **
** Service ID       : NA                                                      **
**                                                                            **
** Sync/Async       : Synchronous                                             **
...
**                                                                            **
** Description      :This function is to check the ADC_E_BUSY DET for         **
**                   Adc_EnableHwTrigger API with HW-SW priority              **
** [/cover]                                                                   **
** Service ID       : NA                                                      **
**                                                                            **
** Sync/Async       : Synchronous                                             **
                               ...
                               const Adc_GroupType GroupId, const uint32 CoreId)
{
  ...
  if (lErrVal != ADC_E_NO_ERR)
  {
    /* [cover parentID={FA52A601-3C72-4b69-B701-5A9D407A9FB7}]
    Report ADC_E_BUSY DET [/cover] */
    Adc_lReportError(ADC_SID_ENABLE_HARDWARE_TRIGGER, ADC_E_BUSY);
  }
  return(lErrVal);
...
**                   state IDLE or any notification registered and reports    **
**                   hardware unit disengaged DET for Adc_SetPowerState AP    **
** [/cover]                                                                   **
** Service ID       : NA                                                      **
**                                                                            **
** Sync/Async       : Synchronous                                             **
  ...
  for(lKernelCount=(uint32)0U; lKernelCount<ADC_MAX_KERNEL_ID; lKernelCount++)
  {
        ...
        NULL_PTR)
    {
          ...
          (lKernelDataPtr->GrpNotifStatus != (uint32)0U) )
      {
        ...
        Report ADC_E_NOT_DISENGAGED DET [/cover] */
        Adc_lReportError(ServiceId, ADC_E_NOT_DISENGAGED);
        break;
      }
    }
  }
...
static void Adc_lReportError(const uint8 ApiId, const uint8 ErrorId)
{
  ...
  Det_ReportError(ADC_MODULE_ID, ADC_MODULE_INSTANCE, ApiId, ErrorId);
  #endif
