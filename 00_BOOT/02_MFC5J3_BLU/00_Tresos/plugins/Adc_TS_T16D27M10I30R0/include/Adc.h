...
#define Adc_InitCheck(ConfigPtr)     \
                              (ERROR_Adc_InitCheck_NOT_AVAILABLE)
#endif
...
#define Adc_SetupResultBuffer(Group, DataBufferPtr)  \
                      (ERROR_Adc_SetupResultBuffer_NOT_AVAILABLE)
#endif
...
(ERROR_Adc_ReadGroup_NOT_SELECTED_OR_Dma_Mode_Is_ON)
#endif
...
(ERROR_Adc_GetStreamLastPointer_NOT_AVAILABLE)
#endif
...
(ERROR_AdcCalibStatusApi_NOT_SELECTED)
#endif
...
#define Adc_PreparePowerState(PowerState,Result)     \
                              (ERROR_Adc_PreparePowerState_NOT_AVAILABLE)
#endif
...
#define Adc_SetPowerState(Result)     \
                              (ERROR_Adc_SetPowerState_NOT_AVAILABLE)
#endif
...
#define Adc_GetTargetPowerState(TargetPowerState,Result)     \
                              (ERROR_Adc_GetTargetPowerState_NOT_AVAILABLE)
#endif
...
#define Adc_GetCurrentPowerState(CurrentPowerState,Result)     \
                              (ERROR_Adc_GetCurrentPowerState_NOT_AVAILABLE)
#endif
