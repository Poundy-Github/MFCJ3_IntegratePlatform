 ...
 **
 **/
extern tFlashStatus FLASH_WriteBuffer(tFlashAddress uAddr,u32 ulLen,const u8 FLASH_FAR_POINTER aubData);
...
extern tFlashStatus FLASH_Erase(tFlashAddress uAddr, u32 ulLen);
 ...
 **
 **/
extern tFlashStatus FLASH_Read(tFlashAddress uAddr,u32 ulLen, u8 *aubData);
