 ...
 ** \param[in] uwLength length of the received data
 **
 ** \return Result of treatment
 ** \retval PROG_E_OK header is complete
 ** \retval PROG_E_NOT_OK header is not complete
 **/
NCS_PRI_FCT tProgStatus PROG_CheckCompleteHeader(u8 * pubHeaderAddr,u16 uwLength);
...
tProgStatus PROG_CheckPSIValue(u8 ubPartitionId, tProgPsiValue ePsiValue)
{
    ...
    u8 ubLoopIndex;
    u32 ulPSIAddress;
    u8 aubPSIAddress[PROG_PSI_SIZE];
...
void PROG_Entry_DecompHeader(void)
{
    ...
    if(eProgStatus == PROG_E_OK)
    {
        eProgStatus = PROG_DecompressData (&m_stDiagMessageInfo.pubData[10], (m_stDiagMessageInfo.uwLength - 10U));
...
void PROG_Entry_ValidateSBASignature(void)
{
    ...
    m_stProgAsymPublicKey.data[(PROG_KEY_LENGTH/sizeof(u32)) + 1] = (PROG_KEY_LENGTH/sizeof(u32)); /* Modulus size */
    for(ubIdx = 0U; /* Modulus */
        ubIdx < m_stProgAsymPublicKey.data[(PROG_KEY_LENGTH/sizeof(u32)) + 1];
        ubIdx++)
    {
...
tUdsStatus PROG_CheckProgrammingDependencies_Impl20(u16 *puwLen, u8 *aubUdsData)
{
    ...
    if ((NULL_PTR != puwLen) && (NULL_PTR != aubUdsData))
    {
        ...
        *puwLen = 9U;
        ...
        if (PROG_E_OK == eProgStatus)
        {
            ...
            while(eProgStatus == PROG_E_OK)
            {
                if(ubPartitionId <= (uwCalPartitionNbr + 1U))
                {
                    ...
                    eProgStatus = PROG_GetSegmentByAddress(ulAddress, ulSize, PROG_MEM_OPERATION_TYPE_READ, &m_stCurrentSegment.ubSegmentId);
        ...
        aubUdsData[6] = 0x00U | ( (0x04U & (u8)(m_ubNormComEnabled<<2)) | (0x02U & (u8)(m_ubIsLocked<<1)) );
    ...
    if(uwlength > 4U)
    {
       ...
       if(uwDataType == PROG_DATATYPE_SIGNED)
       {
...
#endif
        {
            ...
            eProgStatus=PROG_CheckCompleteHeader(&pubdata[2], (uwlength-2));
...
void PROG_Entry_TD_Header(void)
{
    ...
    /* Get Data Type */
    uwDataType = (u16)((u16)((u16)((u16)m_stDiagMessageInfo.pubData[2] << 8U) & 0xFF00U) | (u16)((u16)m_stDiagMessageInfo.pubData[3] & 0x00FFU));
    ...
    switch(uwDataType)
    {
        case PROG_DATATYPE_SIGNED:
 ...
 #endif
            {
                ...
                eProgStatus=PROG_CheckCompleteHeader(&m_stDiagMessageInfo.pubData[4], (m_stDiagMessageInfo.uwLength-4));
        ...
        case PROG_DATATYPE_COMPRESSED:
            ...
            if(m_stReprogInfo.ubCompRequired == TRUE)
            {
                ...
                if(m_stDiagMessageInfo.uwLength > 10U)
                {
...
void PROG_Entry_ValidateSignature(void)
{
    ...
    else
    {
        ...
        {
            uwRegionNbr = (u16)((u16)((u16)((u16)m_pubHeaderAddress[30] << 8U) & 0xFF00U) | (u16)((u16)m_pubHeaderAddress[31] & 0x00FFU));
...
)
{
    ...
    if(ubRegionIndex < m_stCurrentSegment.ubRegionNbr)
    {
        ...
        do
        {
            ...
            if((ulRemaningDataToWrite > 0) && ((eProgStatus == PROG_E_OK) || (eProgStatus == PROG_E_BUSY)))
            {
...
NCS_PRI_FCT tProgStatus PROG_CheckSignedHeader(u8 * pubHeaderAddr)
{
    ...
    /* Get Module Id */
    uwModuleId = (u16)((u16)((u16)((u16)pubHeaderAddr[0] << 8U) & 0xFF00U) | (u16)((u16)pubHeaderAddr[1] & 0x00FFU));
    /* Get BCID/CCID Id */
    uwXCID = (u16)((u16)((u16)((u16)pubHeaderAddr[2] << 8U) & 0xFF00U) | (u16)((u16)pubHeaderAddr[3] & 0x00FFU));
...
NCS_PRI_FCT tProgStatus PROG_FinalizeCheckSignedHeader(const u8 * pubHeaderAddr)
{
    ...
    /* Check Module Id */
    uwModuleId = ((u16)((u16)((u16)pubHeaderAddr[0] << 8U) & 0xFF00U) | (u16)(((u16)pubHeaderAddr[1]) & 0x00FFU));
    uwRegionNbr = ((u16)((u16)((u16)pubHeaderAddr[30] << 8U) & 0xFF00U) | (u16)(((u16)pubHeaderAddr[31]) & 0x00FFU));

    if(uwModuleId == PROG_SW_APP_ID)
    {
        uwNBID = ((u16)((u16)((u16)pubHeaderAddr[28] << 8U) & 0xFF00U) | (u16)(((u16)pubHeaderAddr[29]) & 0x00FFU));
        ...
        if((uwNBID >= uwStoredNBID) || (ubStoredSBIFlag == TRUE))
        {
...
#endif
            {
                ...
                m_stDiagMessageInfo.uwLength -= uwHeaderSize;
            }
#if (PROG_COMPRESSION_ENABLE == STD_ON)
            else
            {
...
NCS_PRI_FCT tProgStatus PROG_CheckCompleteHeader(u8 * pubHeaderAddr,u16 uwLength)
{
    ...
    if (uwLength >= PROG_MIN_HEADER_SIZE)
    {
        /* Get Module Id */
        uwModuleId = (u16)((u16)((u16)((u16)pubHeaderAddr[0] << 8U) & 0xFF00U) | (u16)((u16)pubHeaderAddr[1] & 0x00FFU));
        ...
        {
            /* Application header */
            if (uwLength >= PROG_MIN_APP_HEADER_SIZE)
            {
                /* Get region number */
                uwRegionNbr = (u16)((u16)((u16)((u16)pubHeaderAddr[30] << 8U) & 0xFF00U) | (u16)((u16)pubHeaderAddr[31] & 0x00FFU));

                if (uwLength >= (PROG_MIN_APP_HEADER_SIZE + ((uwRegionNbr-1)*16)))
                {
                    /* Get AppSwInfo size */
                    ulAppSwInfoSize = PROG_GetAppSwSize(pubHeaderAddr,uwRegionNbr);
                    if (uwLength >= (PROG_MIN_APP_SIGNED_HEADER_SIZE + ((uwRegionNbr-1)*8) + (u16)ulAppSwInfoSize))
                    {
                        /* Header is complete */
                        eProgStatus = PROG_E_OK;
                    }
...
NCS_PRI_FCT u32 PROG_GetAppSwSize(u8 * pubHeaderAddr, u16 uwRegionNbr)
{
    ...
    ulSize = (u32)((u32)((u8*)(&(PROG_GET_CALIB_SW_MODULE_NBR_ADDR_FROM_REQ(pubHeaderAddr,ubCalNum,uwRegionNbr))[2U + uwModNum]))
                /* Deviation MISRAC2012-1 */
                - (u32)((u8*)(&pubHeaderAddr[860 + (8U * uwRegionNbr)])));
...
void PROG_HSMUpdate_TD(void)
{
    ...
    if(m_stReprogInfo.ubCompRequired == TRUE)
    {
        ...
        if((eCompStatus == PROG_DECOMP_FINISH) || (eCompStatus == PROG_DECOMP_IN_PROGRESS ))
        {
            ...
            m_uwHsmbufferlength = uwlength;
            for(uwIdx = 0U; uwIdx < uwlength; uwIdx++)
            {
    ...
    {
       /*Copy the all Decompressed data from TD request to HSM Buffer*/
       m_uwHsmbufferlength = m_stDiagMessageInfo.uwLength-2;
       for(uwIdx = 0U; uwIdx < m_uwHsmbufferlength; uwIdx++)
       {
         m_aubHsmbuffer[uwIdx] = m_stDiagMessageInfo.pubData[uwIdx+2];
       }
    }
    ...
    )
    {
        if(m_uwHSMTimeoutCnt <= PROG_HSM_TIMEOUT)
        {
          ...
          eProgStatus = Prog_HSMTransferData(&m_aubHsmbuffer[0],m_uwHsmbufferlength, &uwHsmPEC);
          ...
          if(eProgStatus != PROG_E_BUSY)
          {
             ...
             if( uwHsmPEC == PROG_PEC_NO_ERROR)
             {
                ...
                {
                    PROG_DecompWriteDataConfirmation((u16)(m_uwHsmbufferlength & 0x0000FFFFU));
