...
#if (defined IPDUM_DATA_MEM_SIZE_32BIT_WORDS)
#error IPDUM_DATA_MEM_SIZE_32BIT_WORDS already defined!
#endif /* #if (defined IPDUM_DATA_MEM_SIZE_32BIT_WORDS)*/
 ...
 *       IpduM_GDataMemPtr.
 */
STATIC TS_DefMaxAlignedByteArray(IpduM_DataMem, IPDUM, VAR_NOINIT, IPDUM_DATA_MEM_SIZE);
 ...
 */
/* !LINKSTO IPDUM.ASR40.IPDUM075,1 */
CONSTP2VAR(uint8, AUTOMATIC, IPDUM_VAR_NOINIT) IpduM_GDataMemPtr = (P2VAR(uint8, IPDUM_CONST, IPDUM_VAR_NOINIT)) IpduM_DataMem;
