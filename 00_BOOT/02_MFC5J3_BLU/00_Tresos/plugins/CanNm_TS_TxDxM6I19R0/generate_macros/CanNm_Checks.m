...
[!SELECT "CanNmGlobalConfig/*[1]"!]
  [!IF "(as:modconf('CanNm')/CanNmGlobalConfig/*/CanNmPnEiraCalcEnabled = 'true') and
...
[!LOOP "CanNmGlobalConfig/*[1]/CanNmChannelConfig/*"!]
  ...
  [!/* === Checks for Rx Pdu === */!]
    ...
    [!IF "((node:current()/CanNmPnEnabled = 'true') and
    ...
    [!IF "(not(node:refvalid(CanNmTxPdu/CanNmTxPduRef)) and
           (CanNmUserDataLength > (as:ref(CanNmRxPdu/*[1]/CanNmRxPduRef)/PduLength -
