 ...
 **                                 successful.
 ** \param[inout] RxSessionInfoPtr  Pointer to the session data of this RxPduId.
 **
 ...
 **                                 upper layer module.
 ** \param[inout] TxSessionInfoPtr  Pointer to the session data of this TxPduId.
 **
 ** \return Result of buffer request
...
#endif /* if !defined( PDUR_WRAPASR32_H ) */
/*==================[end of file]===========================================*/
