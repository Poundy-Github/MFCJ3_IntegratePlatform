...
)
{
   ...
   /* initialize return value, TODO: name the method allowing this, i.e set if one not okay */
   RetVal = E_OK;
      ...
      corresponding single core API MultiUpIfTransmit is called */
   {
      ...
      /* TODO: think about dynamic length check as length comparison */
...
#else
   {
      ...
      CONSTP2VAR(uint8, AUTOMATIC, PDUR_VAR_NOINIT) pMultiIfTxInfo =
