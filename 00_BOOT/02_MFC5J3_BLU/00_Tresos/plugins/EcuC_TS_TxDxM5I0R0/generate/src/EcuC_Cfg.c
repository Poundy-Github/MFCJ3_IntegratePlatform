...
#define ECUC_START_SEC_VAR_NO_INIT_64
#include <EcuC_MemMap.h>

/* Space reserved for configured meta data items */
STATIC VAR(uint64, ECUC_VAR) EcuC_MetaDataMemory[[!"num:i($Meta_Data_Config_Size_Max)"!]U];

#define ECUC_STOP_SEC_VAR_NO_INIT_64
#include <EcuC_MemMap.h>
