...
/* patch version check */
#if (DET_SW_PATCH_VERSION < 1U)
#error DET_SW_PATCH_VERSION wrong (< 1U)
#endif
...
/** \brief Report errors.
 **
 ** This function reports errors. The error type is selected using the Det_ErrorType
...
VAR(uint16, DET_VAR_NOINIT)              Det_WriteIndex_DevelopmentError;
VAR(uint16, DET_VAR_NOINIT)              Det_WriteIndex_RuntimeError;
VAR(uint16, DET_VAR_NOINIT)              Det_WriteIndex_TransientFault;
VAR(uint16, DET_VAR_NOINIT)              Det_UsedSlots_DevelopmentError;
VAR(uint16, DET_VAR_NOINIT)              Det_UsedSlots_RuntimeError;
VAR(uint16, DET_VAR_NOINIT)              Det_UsedSlots_TransientFault;
VAR(uint16, DET_VAR_NOINIT)              Det_ErrorLost_DevelopmentError;
VAR(uint16, DET_VAR_NOINIT)              Det_ErrorLost_RuntimeError;
VAR(uint16, DET_VAR_NOINIT)              Det_FaultLost_TransientFault;
...
VAR(uint8, DET_VAR_NOINIT)              Det_ErrorIndex;
...
VAR(Det_ErrorBufferType, DET_VAR_NOINIT) Det_ErrorBuffer[DET_NR_OF_ERROR_TYPES][DET_BUFFERSIZE];

#if (DET_MULTICORE_ENABLED == TRUE)
VAR(Atomic_t, DET_VAR_NOINIT)              Det_WriteIndex_DevelopmentError;
VAR(Atomic_t, DET_VAR_NOINIT)              Det_WriteIndex_RuntimeError;
VAR(Atomic_t, DET_VAR_NOINIT)              Det_WriteIndex_TransientFault;
VAR(Atomic_t, DET_VAR_NOINIT)              Det_UsedSlots_DevelopmentError;
VAR(Atomic_t, DET_VAR_NOINIT)              Det_UsedSlots_RuntimeError;
VAR(Atomic_t, DET_VAR_NOINIT)              Det_UsedSlots_TransientFault;
VAR(Atomic_t, DET_VAR_NOINIT)              Det_ErrorLost_DevelopmentError;
VAR(Atomic_t, DET_VAR_NOINIT)              Det_ErrorLost_RuntimeError;
VAR(Atomic_t, DET_VAR_NOINIT)              Det_FaultLost_TransientFault;
VAR(Atomic_t, DET_VAR_NOINIT)              Det_ErrorIndex;
...
FUNC(void, DET_CODE) Det_Init(void)
{
  ...
  for(Det_ErrorIndex = 0U; Det_ErrorIndex < DET_NR_OF_ERROR_TYPES; ++Det_ErrorIndex)
  {
    for (Det_WriteIndex_DevelopmentError = 0U; Det_WriteIndex_DevelopmentError < DET_BUFFERSIZE; ++Det_WriteIndex_DevelopmentError)
    {
      Det_ErrorBuffer[Det_ErrorIndex][Det_WriteIndex_DevelopmentError].ModuleId   = 0U;
      Det_ErrorBuffer[Det_ErrorIndex][Det_WriteIndex_DevelopmentError].InstanceId = 0U;
      Det_ErrorBuffer[Det_ErrorIndex][Det_WriteIndex_DevelopmentError].ApiId      = 0U;
      Det_ErrorBuffer[Det_ErrorIndex][Det_WriteIndex_DevelopmentError].ErrorId    = 0U;
    }
  }
...
/* !LINKSTO Det.EB.req.multicore.AtomicVarInit,1 */
  Det_WriteIndex_DevelopmentError = ATOMICS_OBJECT_INITIALIZER(0U);
  Det_WriteIndex_RuntimeError     = ATOMICS_OBJECT_INITIALIZER(0U);
  Det_WriteIndex_TransientFault   = ATOMICS_OBJECT_INITIALIZER(0U);
  Det_ErrorLost_DevelopmentError  = ATOMICS_OBJECT_INITIALIZER(0U);
  Det_ErrorLost_RuntimeError      = ATOMICS_OBJECT_INITIALIZER(0U);
  Det_FaultLost_TransientFault    = ATOMICS_OBJECT_INITIALIZER(0U);
  Det_UsedSlots_DevelopmentError  = ATOMICS_OBJECT_INITIALIZER(0U);
  Det_UsedSlots_RuntimeError      = ATOMICS_OBJECT_INITIALIZER(0U);
  Det_UsedSlots_TransientFault    = ATOMICS_OBJECT_INITIALIZER(0U);
  Det_ErrorIndex                  = ATOMICS_OBJECT_INITIALIZER(0U);
#endif /* DET_MULTICORE_ENABLED == FALSE */
  ...
  P2VAR(Std_VersionInfoType, AUTOMATIC, DET_APPL_DATA) VersionInfoPtr)
{
  ...
  {
    /* DET023, DET051, EB_Ref.SWS_Det_00052.UserErrorHooks */
    ...
    /* EB_Ref.SWS_Det_00052.ReportRuntimeErrorCallout */
    (void)Det_ASR43_ReportRuntimeError(
    DET_MODULE_ID, 0U, DET_SID_GET_VERSION_INFO, DET_E_PARAM_POINTER);
    /* EB_Ref.SWS_Det_00052.ReportTransientFaultCallout */
    (void)Det_ASR43_ReportTransientFault(
    DET_MODULE_ID, 0U, DET_SID_GET_VERSION_INFO, DET_E_PARAM_POINTER);
  }
