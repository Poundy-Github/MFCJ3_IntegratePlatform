...
#if (!defined CANTP_GPT[!"$postBuildVariant"!]_CBK_H)
#define CANTP_GPT[!"$postBuildVariant"!]_CBK_H
[!ELSE!]
[!/* Current PB variant Sufix
  */!][!VAR "VariantSuffix"="string("")"!]
#if (!defined CANTP_GPT_CBK_H)
...
/*==================[end of file]============================================*/
[!IF "var:defined('postBuildVariant')"!]
#endif /* if !defined( CANTP_GPT[!"$postBuildVariant"!]_CBK_H ) */
[!ELSE!]
#endif /* if !defined( CANTP_GPT_CBK_H ) */
[!ENDIF!]
