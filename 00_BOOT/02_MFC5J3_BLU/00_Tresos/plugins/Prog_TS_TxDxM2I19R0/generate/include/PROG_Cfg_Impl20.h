...
#define PROG_APP_SW_INFO_ADDR                              (u32)TS_aubAppSwInfo
#endif
...
#define PROG_GET_APP_SW_CONF_OPT_ADDR                       ((u8*)(&m_pubAppSwInfo[2U]))
...
#define PROG_GET_APP_SW_NBID_ADDR                           ((u8*)(&m_pubAppSwInfo[8U]))
...
#define PROG_GET_APP_SW_REGION_NB_ADDR      ((u8*)(&m_pubAppSwInfo[16U + ((PROG_GET_APP_SW_CONF_OPT)*16U)]))
