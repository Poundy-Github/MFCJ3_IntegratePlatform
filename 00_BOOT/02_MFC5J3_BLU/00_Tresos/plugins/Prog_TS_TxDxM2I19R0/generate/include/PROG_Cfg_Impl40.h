...
#define PROG_SIGNATURE_VERIFICATION_ON_FLASHED_DATA        [!WS "8"!][!IF "DownloadVerification/SignatureVerificationOnFlashData = 'true'"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!][!CR!]
[!IF "DownloadVerification/AdditionalCRCComputation = 'true'"!]
#define PROG_VERIFICATION_METHOD                           PROG_VERIFICATION_SIGNATURE_AND_CRC
#define PROG_CRC_CALCULATION                               PROG_TD_CRC32
#define PROG_CRC_ALGO                                      PROG_CRC32_ETHERNET
[!ELSE!]
