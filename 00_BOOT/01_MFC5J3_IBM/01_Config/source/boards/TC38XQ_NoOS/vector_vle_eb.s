 ...
 */
    ...
    Platforms_extern BoardInvalidException0
    Platforms_extern BoardInvalidException1
    Platforms_extern BoardInvalidException2
    Platforms_extern BoardInvalidException3
    Platforms_extern BoardInvalidException4
    Platforms_extern BoardInvalidException5
    Platforms_extern BoardInvalidException6
    Platforms_extern BoardInvalidException7
...
BoardExceptionTable:
  ...
  BOARD_GEN_EXCEPTIONS(Board_Trap0, 0, BoardInvalidException0)
/*==============================================================================
 *  Internal protection traps
 *==============================================================================*/
  Platforms_align(32,5)
  BOARD_GEN_EXCEPTIONS(Board_Trap1, 1, BoardInvalidException1)
/*==============================================================================
 *  Instruction errors
 *==============================================================================*/
  Platforms_align(32,5)
  BOARD_GEN_EXCEPTIONS(Board_Trap2, 2, BoardInvalidException2)
/*==============================================================================
 *  Context management errors
 *==============================================================================*/
  Platforms_align(32,5)
  BOARD_GEN_EXCEPTIONS(Board_Trap3, 3, BoardInvalidException3)
/*==============================================================================
 *  System bus and peripheral errors
 *==============================================================================*/
  Platforms_align(32,5)
  BOARD_GEN_EXCEPTIONS(Board_Trap4, 4, BoardInvalidException4)
/*==============================================================================
 *  Assertion traps
 *==============================================================================*/
  Platforms_align(32,5)
  BOARD_GEN_EXCEPTIONS(Board_Trap5, 5, BoardInvalidException5)
/*==============================================================================
 *  System call exception
  *==============================================================================*/
  Platforms_align(32,5)
  BOARD_GEN_EXCEPTIONS(Board_Trap6, 6, BoardInvalidException6)
/*==============================================================================
 *  NMI, watchdog and PLL traps
 *==============================================================================*/
  Platforms_align(32,5)
  BOARD_GEN_EXCEPTIONS(Board_Trap7, 7, BoardInvalidException7)
