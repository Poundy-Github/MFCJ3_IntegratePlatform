...
VAR(ComGlobalTimeType, COM_VAR_NOINIT) Com_GlobalTime;
#else
VAR(ComGlobalTimeType_Tx, COM_VAR_NOINIT) Com_GlobalTimes_Tx;
VAR(ComGlobalTimeType_Rx, COM_VAR_NOINIT) Com_GlobalTimes_Rx;
 ...
 */
P2CONST(Com_ConfigType, COM_VAR_NOINIT, COM_APPL_CONST) Com_gConfigPtr;
/* CHECK: RULE 506 ON */
...
)
{
   ...
   CONSTP2CONST(uint8, AUTOMATIC, COM_VAR_NOINIT) dataPtr =
