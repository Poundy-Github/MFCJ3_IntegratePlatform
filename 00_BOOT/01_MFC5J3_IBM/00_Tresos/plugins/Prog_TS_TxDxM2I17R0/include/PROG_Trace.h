 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_REQUESTSEED_ENTRY(puwLen,aubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_SENDKEY_ENTRY(puwLen,aubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_REQUESTDOWNLOAD_ENTRY(puwLen,aubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_TRANSFERDATA_ENTRY(puwLen,aubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_REQUESTTRANSFEREXIT_ENTRY(puwLen,aubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_ERASEMEMORY_ENTRY(puwLen,aubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_WRITEFINGERPRINT_ENTRY(puwLen,aubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_REQCHECKPROGPRECONDITION_ENTRY(puwLen,aubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_ECURESET_ENTRY(puwLen,aubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_AUTOCONTROL_ENTRY(puwLen, aubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_ACTIVESBL_ENTRY(puwLen, aubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_UPDATEPSI_ENTRY(puwLen, aubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_CONTROLDTCSETTING_ENTRY(puwLen, aubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_COMMUNICATIONCONTROL_ENTRY(puwLen,aubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_CHECKMEMORY_ENTRY(puwLen,aubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_CHECKPROGRAMMINGDEPENDENCIES_ENTRY(puwLen,aubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_READFINGERPRINT_ENTRY(puwLen,aubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_DSC01CBK_ENTRY(puwLen,aubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_DSC02CBK_ENTRY(puwLen,aubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_DSC03CBK_ENTRY(puwLen,aubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_GETACTIVECURRENTSESSION_ENTRY(puwLen,aubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_GETCURRENTDIAGAPP_ENTRY(puwLen,aubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_GETBOOTSTATUS_ENTRY(puwLen,aubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_GETPEC_ENTRY(puwLen,aubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_GETECUID_ENTRY(puwLen,aubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_GETECUADDR_ENTRY(puwLen,aubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_GETECUNAME_ENTRY(puwLen,aubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_GETSBATICKET_ENTRY(puwLen,aubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_GETBOOTINFO_ENTRY(puwLen,aubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_GETPSIVALUES_ENTRY(puwLen,aubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_ENTRY_ERASE_ENTRY(uwLen,paubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_DECOMPRESSDATA_ENTRY(pubData, uwDataLength)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_GETDECOMPRESSEDDATA_ENTRY(pubDecompData,puwDecompressLength)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_MEMDATAACCESS_ENTRY(eMemType, eOperationType,uMemAddress,uLength,paubDataBuffer)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_COHERENCYCHECK_ENTRY(puwLen,aubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_PROG_COHERENCYPRECHECK_ENTRY(puwLen,paubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
