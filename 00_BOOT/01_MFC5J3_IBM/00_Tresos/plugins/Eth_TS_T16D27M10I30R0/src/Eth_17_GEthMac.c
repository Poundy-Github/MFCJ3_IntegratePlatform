...
/* Macros for number of fSPB cycles to wait after DMA Reset */
#define ETH_17_GETHMAC_DMA_RESET_WAITCYCLE       (0x00000004UL)
...
/* MISRA2012_RULE_4_10_JUSTIFICATION: Memmap header is repeatedly included
   without safegaurd. It complies to Autosar guidelines.*/
#include "Eth_17_GEthMac_MemMap.h"
/* MISRA2012_RULE_8_7_JUSTIFICATION: Core Specific Ethernet driver status.
As per Ethernet driver product requirement,this state shall be available
for debugging purpose.Hence it is declared as extern in the Ethernet driver
header file.*/
uint32* const Eth_17_GEthMac_CoreInitStatus[ETH_17_GETHMAC_MAX_CORES] =
{
  #if (ETH_17_GETHMAC_MAX_CNTRL_CORE0 != 0xFFU)
  #if (ETH_17_GETHMAC_MAX_CNTRL_CORE0 != 0U)
...
[/cover] */
...
#endif /* End of ETH_17_GETHMAC_DEV_ERROR_DETECT */
  {
    ...
    *(Eth_17_GEthMac_CoreInitStatus[CoreId]) = (uint32)ETH_STATE_UNINIT;
    ...
    {
      /* Initialize Buffer Descriptor pointer for the current conreoller */
    ...
    if(RetValue == E_OK)
    {
       /* [cover parentID={00C29C67-C776-4fe1-B569-B689B020DDAD}]
         [/cover] */
      *(Eth_17_GEthMac_CoreInitStatus[CoreId]) = (uint32)ETH_STATE_INIT;
    }
  }
}
...
/*CYCLOMATIC_Eth_17_GEthMac_ProvideTxBuffer_JUSTIFICATION: Function performs
  ...
  functional checks are added enable schms for interrupt mode and allocating
  the requested buffer, Therefore this function has cyclomatic Complexity
  of 17.*/
                                             ...
                                             uint16* const LenBytePtr)
{
...
#endif /* End of ETH_17_GETHMAC_DEV_ERROR_DETECT */
  {
    ...
    That is reserved size for header is 18 bytes*/
...
[/cover] */
...
#endif /* End of ETH_17_GETHMAC_DEV_ERROR_DETECT */
  {
    ...
    AddressRegVal = (uint32)
     ...
     ((uint32)((uint32)ETH_17_GETHMAC_MDIO_ADDR_REG_CR_VAL << \
                                     ETH_17_GETHMAC_CRPOSITION))|\
...
/*CYCLOMATIC_Eth_17_GEthMac_Transmit_JUSTIFICATION: Function performs DET check
   ...
   Therefore this function has cyclomatic Complexity of 16.*/
             ...
             const uint16 LenByte, const uint8* const PhysAddrPtr)
{
  ...
  if(DevError == ETH_17_GETHMAC_E_DET_NO_ERR)
  {
    ...
    if(BufIdx >= (Eth_BufIdxType)TxBufTotal)
    {
      ...
      [/cover] */
      Det_ReportError(ETH_17_GETHMAC_MODULE_ID, ETH_17_GETHMAC_INSTANCE_ID,
...
void Eth_17_GEthMac_MainFunction(void)
{
  ...
  if(*(Eth_17_GEthMac_CoreInitStatus[CoreId]) == (uint32)ETH_STATE_INIT)
  {
...
void Eth_17_GEthMac_RxDmaCh0IrqHdlr(const uint8 CtrlIdx)
{
  ...
  const Eth_17_GEthMac_CntrlStatusType *EthLocalCoreStatusPtr;
  const Eth_17_GEthMac_CoreCntrlConfigType *EthLocalCntrlCfgPtr;
  volatile uint32 FrameIndication;
  uint8 MaxLoops = ETH_17_GETHMAC_ZERO;
#if(ETH_17_GETHMAC_DEV_ERROR_DETECT == STD_ON)
  uint32 DevError;
  /* Check if Eth_17_GEthMac_Init is successful */
...
#endif /* End of ETH_17_GETHMAC_DEV_ERROR_DETECT */
  {
    ...
    (EthCntrlAdd->DMA_CH[0].STATUS.B.RBU == ETH_17_GETHMAC_ONE))
    {
      ...
      /* Local function to notify received frames,
       Dummy read of the return value. */
      FrameIndication = Eth_17_lReceiveFrames(CtrlIdx);
     ...
     design. There are no side effects seen by violating this rule.*/
      EthCntrlAdd->DMA_CH[0].RXDESC_TAIL_POINTER.U = \
                         (uint32)(&EthLocalCoreStatusPtr->EthBuffDecPtr->\
                         EthDmaRxDescPtr[EthLocalCntrlCfgPtr->EthRxBufTotal]);
      UNUSED_PARAMETER(FrameIndication);
      MaxLoops++;
...
static void Eth_17_lStartTxRx(const uint8 CtrlIdx)
{
  ...
  EthCntrlAdd->MAC_CONFIGURATION.B.TE = ETH_17_GETHMAC_ONE;

  /* Start Transmission on DMA Channel-0  */
  EthCntrlAdd->DMA_CH[0].TX_CONTROL.B.ST = ETH_17_GETHMAC_ONE;

  /* Enable Mac Receiver */
  EthCntrlAdd->MAC_CONFIGURATION.B.RE = ETH_17_GETHMAC_ONE;
...
static void Eth_17_lStopTxRx(const uint8 CtrlIdx)
{
  ...
  EthCntrlAdd->MAC_CONFIGURATION.B.TE = ETH_17_GETHMAC_ZERO;

  /* Stop Transmission on DMA Channel-0  */
  EthCntrlAdd->DMA_CH[0].TX_CONTROL.B.ST = ETH_17_GETHMAC_ZERO;

  /* Disable Mac Receiver */
  EthCntrlAdd->MAC_CONFIGURATION.B.RE = ETH_17_GETHMAC_ZERO;
                       ...
                       Eth_17_GEthMac_CoreCntrlConfigType* const EthCntrlCfgPtr)
{
  ...
  {
    /* [cover parentID={25C0F72B-9D37-4a58-A578-3AC2D4E4B76C}]
                      ...
                      Eth_17_GEthMac_CoreCntrlConfigType* const EthCntrlCfgPtr)
{
  ...
  /* [cover parentID={486F8B08-E3B8-4580-8260-70BEFF619204}]
  Check whether RGMII mode is configured
  [/cover] */
  if (((EthCntrlCfgPtr->EthCntrlProperties>>ETH_17_GETHMAC_PHYINT_POS)
                            & ETH_17_GETHMAC_SEVEN) == ETH_17_GETHMAC_ONE)
  {
    /* [cover parentID={E27DCBD7-9E4B-4ec6-BB20-6BB34DDD55F8}]
                                                          ...
                                                          const EthCntrlCfgPtr)
{
...
#endif
  {
    ...
    Set Controller init State as INITITAILIZED ( ETH_STATE_INIT)
    [/cover] */
    EthLocalCoreStatusPtr->EthRunTimeOpertnData.CntrlConfigStatus =\
                                               ETH_17_GETHMAC_CNTRL_INITIALIZED;
    /* Ethernet controller is sucessfully iniitlaized Report Pass to DEM*/
    /* [cover parentID={4FC52A3F-5428-436d-8D5F-9C7055CA40D9}]
    Report Pre Pass to DEM for all DEM Erros
    [/cover] */
    /* Report al DEM as prepass ( except ETH_E_ACCESS)*/
                      ...
                      Eth_17_GEthMac_CoreCntrlConfigType* const EthCntrlCfgPtr)
{
  ...
  /* [cover parentID={317A7A85-273A-40e4-A93B-3404B8C8A2A7}]
  Check whether RGMII mode is configured
  [/cover] */
  if(((EthCntrlCfgPtr->EthCntrlProperties>>ETH_17_GETHMAC_PHYINT_POS)&
                                 ETH_17_GETHMAC_SEVEN) == ETH_17_GETHMAC_ONE)
...
static Std_ReturnType Eth_17_lResetDma(const uint8 CtrlIdx)
{
  ...
  DelayTickResolution = Mcal_DelayTickResolution();
  /* Calucate SPB cycles in nanosecond to wait after DMA reset.It is 4 * fSPB*/
  ...
  EthCntrlAdd->DMA_MODE.B.SWR = \
                            (uint8)ETH_17_GETHMAC_DMA_SWR;
  /*Get current STM tick*/
  CurrSTMTick         = Mcal_DelayGetTick();
  BaseSTMTick         = CurrSTMTick;
  IsTimeExpired       = FALSE;
  ...
  if(Eth_17_lDemtimeout(IsTimeExpired,EthLocalCntrlCfgPtr->EthDemAccess) == FALSE)
  {
                                                          ...
                                                          const EthCntrlCfgPtr)
{
  ...
  /* Ethernet Speed Selection based on Ethspeed(10/100/1000 Mbps)
     configuration*/
  EthCntrlAdd->MAC_CONFIGURATION.B.PS = \
                (uint8)EthCntrlCfgPtr->EthCntrlProperties & ETH_17_GETHMAC_ONE;
  EthCntrlAdd->MAC_CONFIGURATION.B.FES = \
              (uint8)(EthCntrlCfgPtr->EthCntrlProperties >> ETH_17_GETHMAC_ONE)\
                                                          & ETH_17_GETHMAC_ONE;
  EthOpMode = (uint8)((EthCntrlCfgPtr->EthCntrlProperties) >>\
                               ETH_17_GETHMAC_OPMODE_POS) & ETH_17_GETHMAC_ONE;
  ...
  if(EthOpMode == ETH_17_GETHMAC_FULL_DUPLEX)
  {
    ...
    [/cover] */
    EthCntrlAdd->MAC_CONFIGURATION.U |= \
                                    (uint32)(ETH_17_GETHMAC_MAC_INIT_CONF_FDX);
  }
  else
  {
    /* Half duplex default configuration  */
    /* [cover parentID={FBEE86AB-FCDD-4188-B493-4572F77199CB}]
    If HALF DUPLEX opmode, update the MAC Confgiuration
    [/cover] */
    EthCntrlAdd->MAC_CONFIGURATION.U |=\
                                    (uint32)(ETH_17_GETHMAC_MAC_INIT_CONF_HDX);
  }
...
[/cover] */
  ...
  EthCntrlAdd->MAC_CONFIGURATION.B.IPC = ETH_17_GETHMAC_ONE;
#endif
}
                                                          ...
                                                          const EthCntrlCfgPtr)
{
  ...
  EthCntrlAdd->DMA_MODE.U = \
                          ETH_17_GETHMAC_DMA_BUS_MODE_INIT_CONF;

  /* Configure DMA system bus mode register. */
  EthCntrlAdd->DMA_SYSBUS_MODE.U = \
                         ETH_17_GETHMAC_DMA_SYSBUS_MODE_INIT_CONF;

  /* Stop MAC and DMA Transmitters*/
  EthCntrlAdd->MAC_CONFIGURATION.B.TE = ETH_17_GETHMAC_ZERO;
  EthCntrlAdd->DMA_CH[0].TX_CONTROL.B.ST = ETH_17_GETHMAC_ZERO;
  ...
  EthCntrlAdd->DMA_CH[0].TX_CONTROL.B.TXPBL = \
                                           (uint8)ETH_17_GETHMAC_DMA_CH0_TXPBL;
                 ...
                 const Eth_17_GEthMac_CoreCntrlConfigType* const EthCntrlCfgPtr)
{
  ...
  to wait before expected hardware behaviour is occurd- That timer init*/
  DelayTickResolution = Mcal_DelayTickResolution();
  ...
  [/cover] */
  /* Timestamp Enable */
  EthCntrlAdd->MAC_TIMESTAMP_CONTROL.B.TSENA = ETH_17_GETHMAC_ONE;

  /*Add time stamp for all frames */
  EthCntrlAdd->MAC_TIMESTAMP_CONTROL.B.TSENALL = ETH_17_GETHMAC_ONE;

  /* Enable PTP packet Processing for Version 2 Format */
  EthCntrlAdd->MAC_TIMESTAMP_CONTROL.B.TSVER2ENA = ETH_17_GETHMAC_ONE;

  /* Enable Processing of PTP over Ethernet Frames */
  EthCntrlAdd->MAC_TIMESTAMP_CONTROL.B.TSIPENA=ETH_17_GETHMAC_ONE;

  /* Disable Processing of PTP Frames Sent over IPv4-UDP.
     In default, it is enabled.*/
  EthCntrlAdd->MAC_TIMESTAMP_CONTROL.B.TSIPV4ENA = ETH_17_GETHMAC_ZERO;

  /* Timestamp digital roll over control for 1 nanosecond accuracy
     That is, each value in nanosecond register represent 1ns*/
  EthCntrlAdd->MAC_TIMESTAMP_CONTROL.B.TSCTRLSSR = ETH_17_GETHMAC_ONE;

  /* Initiliaze system time higher word second with ZERO.*/
  EthCntrlAdd->MAC_SYSTEM_TIME_HIGHER_WORD_SECONDS.B.TSHWR =\
                                                           ETH_17_GETHMAC_ZERO;
  /* Initiliaze system time(Second and Nanosecond part) with  ZERO.*/
  ...
  characters due to SFR Naming constraints. Since compiler support
   more than 32 characters, no side effects seen.*/
  EthCntrlAdd->MAC_SYSTEM_TIME_SECONDS_UPDATE.U = ETH_17_GETHMAC_ZERO;
  ...
  characters due to SFR Naming constraints. Since compiler support
   more than 32 characters, no side effects seen.*/
  EthCntrlAdd->MAC_SYSTEM_TIME_NANOSECONDS_UPDATE.U = ETH_17_GETHMAC_ZERO;
   ...
   *
   *   Cosnider for 50 Mhz Peripheral Bus frequency ,
  ...
  EthCntrlAdd->MAC_TIMESTAMP_CONTROL.B.TSCFUPDT = ETH_17_GETHMAC_ONE;
             ...
             const uint8* const PhysAddrPtr)
{
  ...
  intended design and valid as per DMA hardware design. There are no
  side effects seen by violating this rule.*/
  /* Get controller status */
  EthLocalCoreStatusPtr = Eth_17_lGetCtrlStatusPtr(CtrlIdx);
  /* Get base address of the indexed controller */
                                                          ...
                                                          const EthCntrlCfgPtr)
{
  ...
  EthCntrlAdd->MTL_TXQ0.OPERATION_MODE.U = (uint32) \
  (ETH_17_GETHMAC_MTL_TXQ0_OPERTN_MODE_INIT | (uint32)ETH_17_GETHMAC_MTL_FTQ);
