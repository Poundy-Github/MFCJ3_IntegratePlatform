 ...
 ** \param[in] uwDataLength: length of data to be decompress
 **
 **/
extern tProgStatus PROG_DecompressData(u8* pubData, u16 uwDataLength);

/** \brief Get decompressed data
 **
 ** \param[in] pubDecompData: pointer to location of decompressed data
 ** \param[in] puwDecompressLength: length of decompressed data
