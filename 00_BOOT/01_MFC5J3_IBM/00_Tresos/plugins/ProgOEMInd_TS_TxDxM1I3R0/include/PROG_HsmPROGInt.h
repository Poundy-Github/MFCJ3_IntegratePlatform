...
typedef enum
{
  ...
  PROG_HSM_PROG_GIDX_PROG_SESSION_GUARD_4,
  PROG_HSM_PROG_GIDX_PROG_SESSION_GUARD_8,
...
extern FUNC(boolean, PROG_CODE)
 PROG_HsmPROGSfCHECK_PROG_DEPENDENCIES_TOPGuard1(
  PROG_PDL_SF(const uint8 instIdx));
/* implements guard 'PROG_Custom_Guard_CheckProgDep_EraseMemory()==PROG_E_OK' */
extern FUNC(boolean, PROG_CODE)
...
extern FUNC(void, PROG_CODE)
 PROG_HsmPROGSfCOMPARE_KEYAction3(
  PROG_PDL_SF(const uint8 instIdx));
/* implements guard '(PROG_Custom_Guard_CompareKey_EraseMemory()==PROG_E_OK)' */
extern FUNC(boolean, PROG_CODE)
...
extern FUNC(void, PROG_CODE)
 PROG_HsmPROGSfPROG_SESSIONAction3(
  PROG_PDL_SF(const uint8 instIdx));
/* implements guard 'PROG_Custom_Guard_ProgSession_EraseMemory()==PROG_E_OK' */
extern FUNC(boolean, PROG_CODE)
...
extern FUNC(boolean, PROG_CODE)
 PROG_HsmPROGSfRDGuard2(
  PROG_PDL_SF(const uint8 instIdx));
/* implements guard 'PROG_Custom_Guard_RD_EraseMemory()==PROG_E_OK' */
extern FUNC(boolean, PROG_CODE)
...
extern FUNC(boolean, PROG_CODE)
 PROG_HsmPROGSfTD_TOPGuard3(
  PROG_PDL_SF(const uint8 instIdx));
/* implements guard 'PROG_Custom_Guard_TD_EraseMemory()==PROG_E_OK' */
extern FUNC(boolean, PROG_CODE)
