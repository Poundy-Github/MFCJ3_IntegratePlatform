...
#if (defined _ARM5_C_CORTEXM_) /* to prevent double definition */
#error _ARM5_C_CORTEXM_ already defined
#endif /* if (defined _ARM5_C_CORTEXM_) */

/** \brief compiler symbol for Arm compiler toolchain 5 for CORTEXM */
/* Deviation MISRAC2012-1 */
#define _ARM5_C_CORTEXM_ 1U
