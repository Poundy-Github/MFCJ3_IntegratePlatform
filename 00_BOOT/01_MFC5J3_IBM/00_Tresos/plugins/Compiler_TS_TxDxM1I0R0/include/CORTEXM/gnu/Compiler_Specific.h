...
#if (defined _GCC_C_CORTEXM_) /* to prevent double definition */
#error _GCC_C_CORTEXM_ already defined
#endif /* if (defined _GCC_C_CORTEXM_) */

/** \brief compiler symbol for Gnu compiler */
/* Deviation MISRAC2012-1 */
#define _GCC_C_CORTEXM_ 1U
