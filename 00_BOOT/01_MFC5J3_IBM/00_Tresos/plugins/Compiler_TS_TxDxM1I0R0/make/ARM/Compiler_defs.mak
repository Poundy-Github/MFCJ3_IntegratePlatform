...
CONFIG_T32_GENERATOR  = $(TRESOS_BASE)\plugins\Platforms_$(Platforms_VARIANT)\tools\PerlScripts\config32_generator.pl 
...
$(CONFIG_T32):
	@$(PERL_EXE) $(CONFIG_T32_GENERATOR) $(TRACE32_PATH) > $(CONFIG_T32)

# Name of the debugger (initialization values)
DB_ARM32 ?= $(TRACE32_APP_PATH)\t32marm.exe -c $(TRACE32_PATH)\config.t32
DB_ARM64 ?= $(TRACE32_APP_PATH)\t32marm64.exe -c $(TRACE32_PATH)\config.t32
...
DB ?= $(TRACE32_APP_PATH)\t32marm.exe 
endif
