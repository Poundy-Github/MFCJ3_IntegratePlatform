...
define build-exe-file
	$(EB_VERBOSE)$(LINK) -o $@ @$(LNK_INC) -Wl,-( -lwinmm  $(OUTPUT_PATH_LIBS) $(LIBRARIES_LINK_ONLY) $(TOOLPATH_COMPILER)\lib\w32api\libwinmm.a $(TOOLPATH_COMPILER)\lib\gcc\i686-pc-cygwin\4.0.4\libboundscheck.a -Wl,-) $(LINK_OPT_POST)
	@echo *** BUILD DONE ***
endef
