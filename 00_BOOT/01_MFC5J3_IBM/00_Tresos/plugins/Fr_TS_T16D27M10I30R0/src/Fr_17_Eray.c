...
#if ( FR_17_ERAY_SW_MAJOR_VERSION != 10U )
  #error "FR_17_ERAY_SW_MAJOR_VERSION does not match. "
#endif

#if ( FR_17_ERAY_SW_MINOR_VERSION != 30U )
...
LOCAL_INLINE uint32 Fr_17_Eray_lDetCheckInvPOCState(
...
LOCAL_INLINE void Fr_17_Eray_lChangePOCToReady(const uint8 Fr_CtrlIdx);
...
/* ERAY base address Kernel wise */
  ...
  #else
  static Ifx_ERAY* const ERAY[] = { &MODULE_ERAY1 };
  #endif
#endif
    ...
    */
    ...
    if(RetValue == E_OK)
    {
      ...
      #endif  /* (FR_17_ERAY_CTRL_TEST_COUNT != 0U) */
      {
        ...
        [/cover] */
        /* Switch the CC to POC:Ready state */
        Fr_17_Eray_lChangePOCToReady(Fr_CtrlIdx);

        GoToReady = FR_17_ERAY_POCS_READY;
        ErrorCount += Fr_17_Eray_lWaitTillPOCChange(Fr_CtrlIdx, GoToReady);
...
Std_ReturnType Fr_17_Eray_StartCommunication(const uint8 Fr_CtrlIdx )
{
  ...
  /* Driver is not initialized/invalid controller index, avoid register
     access */
  /* [cover parentID={2B2FE926-88C7-48df-AA7D-C021F12ED0FC}]
  No DET Error due to the previous check ?
  [/cover] */
  if(DevError == FR_17_ERAY_E_DET_NO_ERR)
  {
    ...
    [/cover] */
    /*  FR_17_ERAY_E_INV_POCSTATE */
    DevError = Fr_17_Eray_lDetCheckInvPOCState(Fr_CtrlIdx,
...
Std_ReturnType Fr_17_Eray_AllowColdstart(const uint8 Fr_CtrlIdx )
{
  ...
  /* Driver is not initialized/invalid controller index, avoid register
     access */
  /* [cover parentID={BA276D03-4877-4598-8934-030627FAE090}]
  No DET Error due to the previous check ?
  [/cover] */
  if (DevError == FR_17_ERAY_E_DET_NO_ERR)
  {
    TmpReg8 = ERAY[Fr_CtrlIdx]->CCSV.B.POCS;
    /* [cover parentID={DEA08206-435D-40b3-B6A2-8D7060109A23}]
...
Std_ReturnType Fr_17_Eray_AllSlots(const uint8 Fr_CtrlIdx )
{
  ...
  /* Driver is not initialized/invalid controller index, avoid register
     access */
  /* [cover parentID={4042A601-751F-4261-98B8-99C20D17D3F0}]
  No DET Error due to the previous check ?
  [/cover] */
  if (DevError == FR_17_ERAY_E_DET_NO_ERR)
  {
    ...
    */
    ...
    [/cover] */
    /* [cover parentID={688B621F-49F2-4b18-ADFF-797824DCE16D}]
...
Std_ReturnType Fr_17_Eray_HaltCommunication(const uint8 Fr_CtrlIdx )
{
  ...
  /* Driver is not initialized/invalid controller index, avoid register
     access */
  /* [cover parentID={C04E7AC8-59F1-4fac-B7C3-92084B774CC5}]
  No DET Error due to the previous check ?
  [/cover] */
  if (DevError == FR_17_ERAY_E_DET_NO_ERR)
  {
    /*
      FR_17_ERAY_E_INV_POCSTATE if controller is not synchronized to
      global time
    */
    /* [cover parentID={3F08650D-5E0F-4464-902C-4B1B0F876072}]
    Get the CC synchronization status with global time
    [/cover] */
    /* [cover parentID={6999D2DA-FA53-451d-98B7-9BA104705999}]
    Is Fr CC Not in sync with global time ?
    [/cover] */
    if (Fr_17_Eray_lIsCCInSync(Fr_CtrlIdx) == (uint32)FR_17_ERAY_DEC_ZERO)
    {
      /* [cover parentID={253EE19A-F587-4c03-A2F2-5924EA9B3565}]
      Report DET
      [/cover] */
      Det_ReportError(FR_17_ERAY_MODULE_ID, FR_17_ERAY_INSTANCE_ID,
...
Std_ReturnType Fr_17_Eray_SendWUP(const uint8 Fr_CtrlIdx )
{
  ...
  /* [cover parentID={CC60F882-8BBC-4ff2-A0DF-859485EC8CDE}]
  No DET Error due to the previous check ?
  [/cover] */
  if (DevError == FR_17_ERAY_E_DET_NO_ERR)
  {
                                           ...
                                           )
{
  ...
  /* Driver is not initialized, avoid register access */
  /* [cover parentID={100BE10C-F932-45e8-BE3D-C6D2010280A3}]
  No DET Error due to the previous check ?
  [/cover] */
  if (DevError == FR_17_ERAY_E_DET_NO_ERR)
  {
  ...
  #endif /* (FR_17_ERAY_DEV_ERROR_DETECT == STD_ON) */
  {
    ...
    if (ErrorCount == (uint32)FR_17_ERAY_DEC_ZERO)
    {
      ...
      [/cover] */
      /* Configure the wakeup channel according to parameter Fr_ChnlIdx. */
      ERAY[Fr_CtrlIdx]->SUCC1.B.WUCS = (uint8)Fr_ChnlIdx;
                                      ...
                                      )
{
  ...
  #endif /* (FR_17_ERAY_DEV_ERROR_DETECT == STD_ON) */
  {
    ...
    /* MISRA2012_RULE_10_3_JUSTIFICATION:The value read from the register
       value to be converted to the enum type.The API parameter type is
       an enum type */
    Fr_POCStatusPtr->ErrorMode = \
            (Fr_ErrorModeType) ERAY[Fr_CtrlIdx]->CCEV.B.ERRM;
                                         ...
                                         )
{
  ...
  #endif /* (FR_17_ERAY_DEV_ERROR_DETECT == STD_OFF) */
  {
    ...
    {
      /*Read Header only */
      /* [cover parentID={069188EC-D8E0-409f-8B64-3B43AC3BC60B}]
                                     ...
                                     )
{
  ...
  #endif /* (FR_17_ERAY_DEV_ERROR_DETECT == STD_ON) */
  {
    ...
    if (Fr_17_Eray_MsgBuff2LPduIdxPtr[Fr_CtrlIdx][MsgBuffIdx] == Fr_LPduIdx)
    {
      ...
      ChannelIdx = (uint8)
         ((uint8)((Fr_17_Eray_ConfigPtr->
         CfgPtr[LogIdx].LPduConfigPtr[Fr_LPduIdx].Wrhs1CfgVal >>
         IFX_ERAY_WRHS1_CHA_OFF) & FR_17_ERAY_WRHS1_CHANNEL_MASK) - (uint8)0x1);
                                           ...
                                           )
{
  ...
  [/cover] */
  /* FR_17_ERAY_E_INIT_FAILED */
  DevError = Fr_17_Eray_lDetCheckNoInit(FR_17_ERAY_SID_SETABSOLUTETIMER);
  ...
  /* Driver is not initialized, avoid register access */
  /* [cover parentID={90FB6572-AD8C-4443-AFE0-C5EF9F6E99EC}]
  No DET Error due to the previous check ?
  [/cover] */
  if (DevError == FR_17_ERAY_E_DET_NO_ERR)
  {
    ...
    Get the CC synchronization status with global time
    [/cover] */
    /* [cover parentID={7E1DCAD0-1696-4d81-8340-675C411C2568}]
    Is Fr CC Not in sync with global time ?
    [/cover] */
                                               ...
                                               const uint8 ChiCmdId)
{
  ...
  if (PbsyChk == (uint8)1U)
  {
       ...
       (Dem_EventIdType)FR_17_ERAY_DEM_REPORT_DISABLED)
    {
      ...
      Report the error status as FAILED to DEM
      [/cover] */
      Dem_ReportErrorStatus(Fr_17_Eray_ConfigPtr->
...
**                                                                            **
** Syntax          : void Fr_17_Eray_lChangePOCToReady(const uint8 Fr_CtrlIdx)**
**                                                                            **
...
**                                                                            **
** Syntax          : uint32 Fr_17_Eray_lDetCheckInvPOCState                   **
**                        (const uint8 Fr_CtrlIdx, const uint8 ExpectedState, **
**                                                 const uint8 ServiceId)     **
**                                                                            **
...
** Parameters (out): None                                                     **
**                                                                            **
** Return value    : FR_17_ERAY_E_DET_NO_ERR(0) : POC state is same as        **
**                                                 expected                   **
**                   FR_17_ERAY_E_INV_POCSTATE : POC state is not same as     **
**                                                 expected                   **
**                                                                            **
*******************************************************************************/
LOCAL_INLINE uint32 Fr_17_Eray_lDetCheckInvPOCState(
