...
[!IF "((as:modconf('Prog')/General/Use_CSM_ASR430_DemoWrapper = 'false') and (contains(as:modconf('Prog')/Security/ProgCsmSecureConfigId, '/Csm/Csm/CsmHash/') =  'true')) or
    ((as:modconf('Prog')/General/Use_CSM_ASR430_DemoWrapper = 'true') and (node:exists(node:ref(node:ref(as:modconf('Prog')/Security/ProgCsmSecureConfigId)/CsmJobPrimitiveRef)/CsmHash)) )"!]
...
[!ELSEIF "((as:modconf('Prog')/General/Use_CSM_ASR430_DemoWrapper = 'false') and (contains(as:modconf('Prog')/Security/ProgCsmSecureConfigId, '/Csm/Csm/CsmMacGenerate/') =  'true')) or
...
#define PROG_SECURE_BOOT_ENABLE                            [!WS "28"!][!IF "(as:modconf('BM')/Security/SecureBoot/SECURE_AUTHENTICATED_BOOT = 'Secure')"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!][!CR!]
