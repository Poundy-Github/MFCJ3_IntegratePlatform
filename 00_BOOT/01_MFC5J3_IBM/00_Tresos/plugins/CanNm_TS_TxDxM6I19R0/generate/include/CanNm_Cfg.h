...
#if (!defined CANNM_NO_CFGCLASSMIX_REQUIRED)
...
#define CANNM_RELOCATABLE_CFG_ENABLE [!IF "as:modconf('PbcfgM')/PbcfgMGeneral/PbcfgMRelocatableCfgEnable = 'true'"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!]
#else
...
[!IF "CanNmPnEiraCalcEnabled = 'true' or  num:i(count(CanNmChannelConfig/*[CanNmPnEraCalcEnabled='true'])) > 0"!][!//
[!NOCODE!][!//
