...
#if (defined CANNM_IMMEDIATE_TRANS_BIT)
#error CANNM_IMMEDIATE_TRANS_BIT is already defined
#endif
...
#if (defined CANNM_IMMEDIATE_TRANSMISSION_ACTIVE)
#error CANNM_IMMEDIATE_TRANSMISSION_ACTIVE is already defined
#endif
...
extern VAR(CanNm_ChanStatusType, CANNM_VAR)
   CanNm_ChanStatus[CANNM_NUMBER_OF_CHANNELS];

extern P2CONST(CanNm_ConfigType, CANNM_VAR, CANNM_APPL_DATA) CanNm_RootPtr;
