...
#define BLPDUR_STREAMING_ALLOWED    0U
#define BLPDUR_STREAMING_FORBIDDEN  1U
 ...
 **
 **/
extern void BlPduR_SetTesterAddress(u8 ubTesterAddress);
#endif /*(BLPDUR_SOURCE_ADDRESS_CHECK_ENABLE == STD_ON)*/

/** \brief Retrieve the active connection information
 **
 **
 **/
 ...
 **
 **/
extern void BlPduR_Send_TPFrame(u16 uwLen, u8 *paubData);
 ...
 **
 **/
extern void BlPduR_SimulateRxRequest(u16 uwLen, u8 * paubUdsData, u8 ubWithResp);
...
extern tBlPduRStatus BlPduR_SendMsgData (PduIdType PduId, u16 uwLen, u8 *paubData);
#endif
 ...
 **
 ** \param[out] puwLen Length of the data store in the provided buffer
 ** \param[out] paubData Address of the buffer to treat (Null pointer if no more buffer)
 **/
extern void BlPduR_GetNextBuffer(u16* puwLen, u8 ** paubData);
#endif
...
#endif /* (BLPDUR_MULTIPLE_ID_ENABLE ==  STD_ON) */
