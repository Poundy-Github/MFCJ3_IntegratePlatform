 ...
 * \param[in] None.
 * \param[in,out] None
 * \param[out] NetworkHandleType - The ComM channel Id of the destination network.
 *
 ...
 *
 * \param[in] NetworkHandleType - The ComM channel Id of the source network.
 * \param[in,out] None
 * \param[out] boolean
 *
 ...
 *
 * \param[in] NetworkHandleType - The ComM channel Id of the destination network.
 * \param[in,out] None
 ...
 *
 * \param[in] NetworkHandleType - The ComM channel Id of source or destination network.
 * \param[in,out] None
 * \param[out] Mirror_NetworkType
 *
 ...
 *
 * \param[in] Mirror_NetworkType - The type of the Mirror network.
 * \param[in] uint8 - Mirror network ID
 * \param[in,out] None
 * \param[out] None
 *
 ...
 *
 * \ServiceID{0x50}
 * \Reentrancy{  Reentrant for different controllerIds.
 *               Non reentrant for the same controller Id.  }
 * \Synchronicity{Synchronous}
 */
