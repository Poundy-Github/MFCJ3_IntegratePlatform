...
/* Init check failure */
#define SPI_E_INIT_CHECK_FAIL          ((uint8)0x64U)
...
typedef struct
{
  ...
  /* Specifies the size of the internal buffers
     for the IB channels on the QSPIx HW        */
  uint32 IBBufferSize;
...
typedef struct
{
  ...
  /* Specifies the channel present in the QSPI Hw Unit.
     Lower nibble specifies the QSPI Hw and upper nibble specifies
     whether the channel is assigned to synchronous or asynchronous job */
  uint8 QSPIHwUnit;
  #endif
...
#else
/* MISRA2012_RULE_4_9_JUSTIFICATION: For Error generation if configured wrongly */
#define Spi_WriteIB(Channel, DataBufferPtr) (ERROR_Spi_WriteIB_NOT_SELECTED)
...
#else
/* MISRA2012_RULE_4_9_JUSTIFICATION: For Error generation if configured wrongly */
#define Spi_AsyncTransmit(Sequence) (ERROR_Spi_AsyncTransmit_NOT_SELECTED)
#endif /* (SPI_LEVEL_DELIVERED != 0U) */
...
#else
/* MISRA2012_RULE_4_9_JUSTIFICATION: For Error generation if configured wrongly */
#define Spi_ReadIB(Channel, DataBufferPtr) (ERROR_Spi_ReadIB_NOT_SELECTED)
#endif /* (SPI_CHANNEL_BUFFERS_ALLOWED != 1U) */
...
#else
/* MISRA2012_RULE_4_9_JUSTIFICATION: For Error generation if configured wrongly */
#define Spi_SyncTransmit(Sequence) (ERROR_Spi_SyncTransmit_NOT_SELECTED)
...
** Parameters (out): none                                                     **
**                                                                            **
** Return value    : (Spi_StatusType), SPI_IDLE/SPI_BUSY/SPI_UNINIT           **
**                                                                            **
...
#else
/* MISRA2012_RULE_4_9_JUSTIFICATION: For Error generation if configured wrongly */
#define Spi_GetHWUnitStatus(HWUnit) (ERROR_Spi_GetHWUnitStatus_NOT_SELECTED)
...
#else
/* MISRA2012_RULE_4_9_JUSTIFICATION: For Error generation if configured wrongly */
#define Spi_Cancel(Sequence) (ERROR_Spi_Cancel_NOT_SELECTED)
...
#else
/* MISRA2012_RULE_4_9_JUSTIFICATION: For Error generation if configured wrongly */
#define Spi_SetAsyncMode(Mode) (ERROR_Spi_SetAsyncMode_NOT_SELECTED)
...
#if(SPI_LEVEL_DELIVERED != 0U)
/*******************************************************************************
** Syntax          : void Spi_IsrQspiError(uint8 Module)                      **
**                                                                            **
...
/*******************************************************************************
** Syntax          : void Spi_QspiDmaCallout(const uint32 Channel,            **
...
#else
/* MISRA2012_RULE_4_9_JUSTIFICATION: Agreed violation */
#define Spi_GetVersionInfo(versioninfo) (ERROR_Spi_VersionInfo_NOT_SELECTED)
