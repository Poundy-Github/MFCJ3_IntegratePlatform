 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_UDS_RXREQUEST_ENTRY(puwLen,aubUdsData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_UDS_RXREQUESTWITHADDRMODE_ENTRY(puwLen,aubUdsData,UdsAddrMode,eUdsAddrType)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_UDS_LONGREQUESTEND_ENTRY(uwLen,aubUdsData,eStatus)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
