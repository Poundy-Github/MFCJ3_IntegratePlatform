...
#define PLATFORMS_SRC_CANINT0 (*(volatile uint32 *)(PLATFORMS_SRCBASE+0x05B0u))
#define PLATFORMS_SRC_CANINT1 (*(volatile uint32 *)(PLATFORMS_SRCBASE+0x05B4u))
#define PLATFORMS_SRC_CANINT2 (*(volatile uint32 *)(PLATFORMS_SRCBASE+0x05B8u))
#define PLATFORMS_SRC_CANINT3 (*(volatile uint32 *)(PLATFORMS_SRCBASE+0x05BCu))
#define PLATFORMS_SRC_CANINT4 (*(volatile uint32 *)(PLATFORMS_SRCBASE+0x05C0u))
#define PLATFORMS_SRC_CANINT5 (*(volatile uint32 *)(PLATFORMS_SRCBASE+0x05C4u))
#define PLATFORMS_SRC_CANINT6 (*(volatile uint32 *)(PLATFORMS_SRCBASE+0x05C8u))
#define PLATFORMS_SRC_CANINT7 (*(volatile uint32 *)(PLATFORMS_SRCBASE+0x05CCu))
#define PLATFORMS_SRC_CANINT8 (*(volatile uint32 *)(PLATFORMS_SRCBASE+0x05D0u))
#define PLATFORMS_SRC_CANINT9 (*(volatile uint32 *)(PLATFORMS_SRCBASE+0x05D4u))
#define PLATFORMS_SRC_CANINT10 (*(volatile uint32 *)(PLATFORMS_SRCBASE+0x05D8u))
#define PLATFORMS_SRC_CANINT11 (*(volatile uint32 *)(PLATFORMS_SRCBASE+0x05DCu))
#define PLATFORMS_SRC_CANINT12 (*(volatile uint32 *)(PLATFORMS_SRCBASE+0x05E0u))
#define PLATFORMS_SRC_CANINT13 (*(volatile uint32 *)(PLATFORMS_SRCBASE+0x05E4u))
#define PLATFORMS_SRC_CANINT14 (*(volatile uint32 *)(PLATFORMS_SRCBASE+0x05E8u))
#define PLATFORMS_SRC_CANINT15 (*(volatile uint32 *)(PLATFORMS_SRCBASE+0x05ECu))
