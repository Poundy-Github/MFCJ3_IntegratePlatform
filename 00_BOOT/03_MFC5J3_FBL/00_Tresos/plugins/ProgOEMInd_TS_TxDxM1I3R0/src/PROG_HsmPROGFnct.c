 ...
 * 2) CHECK_MEMORY_TOP -> ERASE_TOP: PROG_EVENT_REQ_ERASE[]/
 ...
 * Transitions originating from this state:
 * 1) PROG_EVENT_CRC_FINISH[]/PROG_CheckSegmentListCrc();
 * 2) CHECK_MEMORY -> CHECK_MEMORY_FINISH: PROG_EVENT_CRYPTO_FINISH[]/(void)PROG_CRC_Compare();
 * 3) CHECK_MEMORY -> CHECK_MEMORY_FINISH: PROG_EVENT_FAILED[]/
...
FUNC(void, PROG_CODE) PROG_HsmPROGSfCHECK_MEMORYAction1(
  PROG_PDL_SF(const uint8 instIdx))
{
 ...
 * 2) CHECK_PROG_DEPENDENCIES_TOP -> ERASE_TOP: PROG_EVENT_REQ_ERASE[PROG_Custom_Guard_CheckProgDep_EraseMemory()==PROG_E_OK]/
 * 3) PROG_EVENT_REQ_GET_SEED[]/PROG_GetSeed_Unlocked();
 * 4) PROG_EVENT_REQ_RTE[]/PROG_Send_NRC(UDS_NRC_24);
 * 5) PROG_EVENT_REQ_TD[]/PROG_Send_NRC(UDS_NRC_24);
...
{
  boolean RetVal;
  /* guard condition 'PROG_Custom_Guard_CheckProgDep_EraseMemory()==PROG_E_OK'
 ...
 * 4) COMPARE_KEY -> ERASE_TOP: PROG_EVENT_REQ_ERASE[(PROG_Custom_Guard_CompareKey_EraseMemory()==PROG_E_OK)]/
...
{
  boolean RetVal;
  /* guard condition '(PROG_Custom_Guard_CompareKey_EraseMemory()==PROG_E_OK)'
   * for PROG_EVENT_REQ_ERASE[...]/
   * external transition to state ERASE_TOP */
 ...
 * 2) PROG_EVENT_REQ_COHERENCY_CHECK[]/PROG_Send_NRC(UDS_NRC_24);
 * 3) PROG_EVENT_REQ_COMPARE_KEY[]/PROG_Send_NRC(UDS_NRC_24);
 * 4) PROG_SESSION -> ERASE_TOP: PROG_EVENT_REQ_ERASE[PROG_Custom_Guard_ProgSession_EraseMemory()==PROG_E_OK]/
 ...
 * 8) PROG_SESSION -> WRITE_FINGERPRINT: PROG_EVENT_REQ_WRITE_FP[PROG_Custom_Guard_ProgSession_FingerPrint()==PROG_E_OK]/
 */
...
FUNC(void, PROG_CODE) PROG_HsmPROGSfPROG_SESSIONAction1(
  PROG_PDL_SF(const uint8 instIdx))
{
  /* action 'PROG_Send_NRC(UDS_NRC_24);'
   * for PROG_EVENT_REQ_CHECKMEMORY[]/...
...
FUNC(boolean, PROG_CODE) PROG_HsmPROGSfPROG_SESSIONGuard4(
  PROG_PDL_SF(const uint8 instIdx))
{
  boolean RetVal;
  /* guard condition 'PROG_Custom_Guard_ProgSession_EraseMemory()==PROG_E_OK'
   * for PROG_EVENT_REQ_ERASE[...]/
   * external transition to state ERASE_TOP */
...
FUNC(boolean, PROG_CODE) PROG_HsmPROGSfPROG_SESSIONGuard8(
  PROG_PDL_SF(const uint8 instIdx))
{
  boolean RetVal;
 ...
 * 3) RD -> ERASE_TOP: PROG_EVENT_REQ_ERASE[PROG_Custom_Guard_RD_EraseMemory()==PROG_E_OK]/
...
{
  boolean RetVal;
  /* guard condition 'PROG_Custom_Guard_RD_EraseMemory()==PROG_E_OK'
   * for PROG_EVENT_REQ_ERASE[...]/
   * external transition to state ERASE_TOP */
 ...
 * Init substate: RTE
 * Transitions originating from this state:
 * 1) RTE_TOP -> ERASE_TOP: PROG_EVENT_REQ_ERASE[]/
 ...
 * Init substate: none, this is a leaf state
 * Transitions originating from this state:
 * 1) RTE -> RTE_FAILED: PROG_EVENT_FAILED[]/
 * 2) RTE -> RTE_FINISH: PROG_EVENT_FINISHED[]/
 */
 ...
 * 4) TD_TOP -> ERASE_TOP: PROG_EVENT_REQ_ERASE[PROG_Custom_Guard_TD_EraseMemory()==PROG_E_OK]/
...
{
  boolean RetVal;
  /* guard condition 'PROG_Custom_Guard_TD_EraseMemory()==PROG_E_OK'
   * for PROG_EVENT_REQ_ERASE[...]/
   * external transition to state ERASE_TOP */
 ...
 * Init substate: none, this is a leaf state
 * Transitions originating from this state:
 * 1) WRITE_CHECK -> TD_CRC: PROG_EVENT_TD_END[]/
 * 2) WRITE_CHECK -> WRITE: PROG_EVENT_WRITE[]/
 */
