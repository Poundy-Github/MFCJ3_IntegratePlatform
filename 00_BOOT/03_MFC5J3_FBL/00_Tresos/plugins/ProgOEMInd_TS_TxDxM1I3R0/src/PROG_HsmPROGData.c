...
#define PROG_HSM_PROG_NUM_EVENTS 29U
  ...
  PROG_HsmPROGActions[PROG_HSM_PROG_NO_OF_ACTIONS] =
{
  ...
  &PROG_HsmPROGSfCHECK_MEMORYAction1,
  ...
  &PROG_HsmPROGSfPROG_SESSIONAction1,
  ...
  PROG_HsmPROGGuards[PROG_HSM_PROG_NO_OF_GUARDS] =
{
  ...
  &PROG_HsmPROGSfPROG_SESSIONGuard4,
  &PROG_HsmPROGSfPROG_SESSIONGuard8,
...
{
  PROG_HSM_PROG_AIDX_CHECK_MEMORY_ACTION_1,
};
/* trans sequence for transition #2 from state CHECK_MEMORY */
STATIC CONST(PROG_HsmActionIdxType, PROG_CONST)
  PROG_HsmTrCHECK_MEMORYSteps2[2] =
{
...
{
  PROG_HSM_PROG_AIDX_PROG_SESSION_ACTION_1,
};
...
/* trans sequence for transition #1 from state RTE */
STATIC CONST(PROG_HsmActionIdxType, PROG_CONST)
  PROG_HsmTrRTESteps1[1] =
{
...
},
{
  ...
  0U,
  PROG_HSM_PROG_EV_PROG_EVENT_REQ_ERASE, /* triggering event */
  PROG_HSM_PROG_GIDX_PROG_SESSION_GUARD_4, /* guard idx */
  PROG_HSM_PROG_SIDX_ERASE_TOP /* target state */
},
{
...
},
{
  ...
  0U,
  PROG_HSM_PROG_EV_PROG_EVENT_REQ_WRITE_FP, /* triggering event */
  PROG_HSM_PROG_GIDX_PROG_SESSION_GUARD_8, /* guard idx */
  PROG_HSM_PROG_SIDX_WRITE_FINGERPRINT /* target state */
},
};
...
{
  PROG_HsmTrRTESteps1,
  sizeof(PROG_HsmTrRTESteps1)/sizeof(PROG_HsmActionIdxType),
  PROG_HSM_PROG_EV_PROG_EVENT_FAILED, /* triggering event */
  PROG_HSM_GIDX_INVALID, /* no guard */
  ...
  PROG_HsmScdPROG[PROG_HSM_PROG_NO_OF_STATES] =
{
  ...
  },
  {
    ...
    PROG_HSM_PROG_SIDX_TD_TOP, /* parent state */
    PROG_HSM_PROG_SIDX_WRITE_CHECK, /* init state */
      PROG_HSM_AIDX_INVALID, /* no entry action */
  ...
  PROG_HsmPROGGuardNames[] =
{
  ...
  "PROG_SESSION guard 4",
  "PROG_SESSION guard 8",
  "RD guard 2",
  "RD guard 3",
  "RD guard 4",
  "RD guard 7",
