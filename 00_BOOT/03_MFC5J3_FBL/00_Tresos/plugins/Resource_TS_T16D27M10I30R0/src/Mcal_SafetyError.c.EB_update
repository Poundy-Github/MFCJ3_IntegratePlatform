...
Commnent include of Test_Print.h and Test_Mcal_SafetyError.h because it is only
needed by Infineon test environment.
*/
/*
#if (APP_SW == DEMO_APP)
...
/*
  Note: Elektrobit Automotive GmbH modified the original code provided
        ...
        use the unmodified files provided with this distribution. 
  Please see for the reasons in the file ImportantNotes.txt for tag
Commnent use of Test_Mcal_ReportSafetyError function because it is only
needed by Infineon test environment.
*/

#define RESOURCEM_START_SEC_CODE
#include "ResourceM_MemMap.h"
...
#define RESOURCEM_STOP_SEC_CODE
#include "ResourceM_MemMap.h"