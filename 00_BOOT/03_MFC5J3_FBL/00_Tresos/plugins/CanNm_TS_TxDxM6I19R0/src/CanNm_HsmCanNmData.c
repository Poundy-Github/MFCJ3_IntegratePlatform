...
STATIC VAR(uint8, CANNM_VAR_NOINIT)
...
STATIC VAR(CanNm_HsmInstType, CANNM_VAR_NOINIT)
  CanNm_HsmInstCanNm[CANNM_HSM_CANNM_NUM_INST];

/* RAM data for event queues */
STATIC VAR(CanNm_HsmEventType, CANNM_VAR_NOINIT)
...
STATIC CONST(CanNm_HsmActionIdxType, CANNM_CONST)
  CanNm_HsmTrReadySleepRemoteActivitySteps2[2] =
{
  CANNM_HSM_CANNM_AIDX_SENDINGSUBMODE_ENTRY,
...
STATIC CONST(CanNm_HsmActionIdxType, CANNM_CONST)
  CanNm_HsmTrReadySleepRemoteSleepSteps2[3] =
{
...
STATIC CONST(CanNm_HsmActionIdxType, CANNM_CONST)
  CanNm_HsmTrPrepareBusSleepModeSteps2[2] =
{
  ...
  CanNm_HsmScdCanNm[CANNM_HSM_CANNM_NO_OF_STATES] =
{
  ...
  },
  {
    ...
    CANNM_HSM_CANNM_SIDX_REPEATMESSAGESTATE, /* init state */
      CANNM_HSM_CANNM_AIDX_SENDINGSUBMODE_ENTRY, /* entry function */
