 ...
 **
 ** Det_ErrorBuffer[Det_ErrorIndex][Det_WriteIndex_<error_type>] is the next field to be overwritten.
...
#if (DET_MULTICORE_ENABLED == FALSE)
extern VAR(uint8, DET_VAR_NOINIT) Det_ErrorIndex;
#else
/* !LINKSTO Det.EB.req.multicore.AtomicTypes,1 */
extern VAR(Atomic_t, DET_VAR_NOINIT) Det_ErrorIndex;
#endif
 ...
 **
 ** Det_ErrorBuffer[Det_ErrorIndex][Det_WriteIndex_DevelopmentError] is the next field to be overwritten.
 ** Variable definition is only available for internal or external logging mode.
 **
 ** Variable shall only be used for debugging. */
extern VAR(uint16, DET_VAR_NOINIT) Det_WriteIndex_DevelopmentError;

/** \brief Index for writing runtime errors into buffer
 **
 ** Det_ErrorBuffer[Det_ErrorIndex][Det_WriteIndex_RuntimeError] is the next field to be overwritten.
 ** Variable definition is only available for internal or external logging mode.
 **
 ** Variable shall only be used for debugging. */
extern VAR(uint16, DET_VAR_NOINIT) Det_WriteIndex_RuntimeError;

/** \brief Index for writing transient faults into buffer
 **
 ** Det_ErrorBuffer[Det_ErrorIndex][Det_WriteIndex_TransientFault] is the next field to be overwritten.
 ** Variable definition is only available for internal or external logging mode.
 **
 ** Variable shall only be used for debugging. */
extern VAR(uint16, DET_VAR_NOINIT) Det_WriteIndex_TransientFault;
 ...
 **
 ** Variable shall only be used for debugging. */
extern VAR(uint16, DET_VAR_NOINIT) Det_ErrorLost_DevelopmentError;
 ...
 **
 ** Variable shall only be used for debugging. */
extern VAR(uint16, DET_VAR_NOINIT) Det_ErrorLost_RuntimeError;
 ...
 **
 ** Variable shall only be used for debugging. */
extern VAR(uint16, DET_VAR_NOINIT) Det_FaultLost_TransientFault;
 ...
 **
 ** Variable shall only be used for debugging. */
extern VAR(uint16, DET_VAR_NOINIT) Det_UsedSlots_DevelopmentError;
 ...
 **
 ** Variable shall only be used for debugging. */
extern VAR(uint16, DET_VAR_NOINIT) Det_UsedSlots_RuntimeError;
 ...
 **
 ** Variable shall only be used for debugging. */
extern VAR(uint16, DET_VAR_NOINIT) Det_UsedSlots_TransientFault;
#else
/* !LINKSTO Det.EB.req.multicore.AtomicTypes,1 */
extern VAR(Atomic_t, DET_VAR_NOINIT) Det_WriteIndex_DevelopmentError;
extern VAR(Atomic_t, DET_VAR_NOINIT) Det_WriteIndex_RuntimeError;
extern VAR(Atomic_t, DET_VAR_NOINIT) Det_WriteIndex_TransientFault;
extern VAR(Atomic_t, DET_VAR_NOINIT) Det_ErrorLost_DevelopmentError;
extern VAR(Atomic_t, DET_VAR_NOINIT) Det_ErrorLost_RuntimeError;
extern VAR(Atomic_t, DET_VAR_NOINIT) Det_FaultLost_TransientFault;
extern VAR(Atomic_t, DET_VAR_NOINIT) Det_UsedSlots_DevelopmentError;
extern VAR(Atomic_t, DET_VAR_NOINIT) Det_UsedSlots_RuntimeError;
extern VAR(Atomic_t, DET_VAR_NOINIT) Det_UsedSlots_TransientFault;
#endif
