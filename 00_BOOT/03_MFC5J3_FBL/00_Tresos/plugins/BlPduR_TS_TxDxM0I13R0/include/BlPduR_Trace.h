 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_BLPDUR_SENDMSGDATA_ENTRY(PduId,uwLen,paubData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_BLPDUR_SEND_TPFRAME_ENTRY(uwLen,paubData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_BLPDUR_SIMULATERXREQUEST_ENTRY(uwLen,paubUdsData,ubWithResp)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
 ...
 ** The macro takes the function arguments as parameters.
 */
#define DBG_BLPDUR_GETNEXTBUFFER_ENTRY(puwLen,paubData)
#endif
/** \brief Exclude section from doxygen
 ** @endcond */
