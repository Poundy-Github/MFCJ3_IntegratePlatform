...
#define BLPDUR_ASR_NETWORK_PRESENT        [!WS "8"!][!IF "as:modconf('BlPduR')/General/Can_Protocol_Supported = 'true'
...
#define BLPDUR_RX_PHY_BUFFER_NUM          1U
[!ENDIF!]
...
#define BLPDUR_RX_BUFFER                  (BLPDUR_RX_PHY_BUFFER_NUM + 1U)

/* Define Pdu for transmition */
[!LOOP "PduConnection/*[LinConnection = 'false']"!]
#define  BLPDUR_[!"name(node:ref(TxPduRef))"!] PDURSA_[!"name(node:ref(TxPduRef))"!]
[!ENDLOOP!]
...
#define BLPDUR_RX_FUNC_BUFFERSIZE         [!"num:i(General/RxFunctionalBufferSize)"!]U
...
#define BLPDUR_MAX_RX_PDU_NUM             [!"num:i($RxPduCount)"!]U
...
[!FOR "GROUP_IDX" = "1" TO "count(IDGroup/*)" STEP "1"!]
    ...
    [!FOR "CONNECT_IDX" = "1" TO "count(IDGroup/*[num:i($GROUP_IDX)]/ConnectionReflist/*)" STEP "1"!]
        ...
        [!ENDSELECT!]
    [!ENDFOR!]
/* Number of CAN ID allow in the ID group [!"num:i($GROUP_IDX - 1)"!] */
