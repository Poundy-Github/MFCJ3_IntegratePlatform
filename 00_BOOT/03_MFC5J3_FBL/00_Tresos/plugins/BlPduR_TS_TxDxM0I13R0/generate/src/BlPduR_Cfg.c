        ...
        [!ELSE!][!/*
            ...
            */!][!LOOP "as:modconf('CanIf')/CanIfInitCfg/*/CanIfRxPduCfg/*"!][!/*
                ...
                */!][!IF "$PduInfo = CanIfRxPduRef"!][!/*
                    ...
                    */!][!WS "4"!][!"num:inttohex(CanIfRxPduCanId)"!],
                [!ENDIF!]
            [!ENDLOOP!]
        [!ENDIF!]
    [!ENDIF!]
...
{
[!IF "General/QueuedManagement = 'true' or General/MultipleRxBuffer = 'true'"!]
...
[!ELSE!]
    {
        &BlPduRRxPhysBuffer[0][0],[!WS "2"!]/* ptrBuffer   */
        &stRxPhysBufferInfo[0],[!WS "6"!]/* bufferInfo  */
        BLPDUR_RX_PHYS_BUFFERSIZE,[!WS "3"!]/* Buffer size */
    },
[!ENDIF!]
};
