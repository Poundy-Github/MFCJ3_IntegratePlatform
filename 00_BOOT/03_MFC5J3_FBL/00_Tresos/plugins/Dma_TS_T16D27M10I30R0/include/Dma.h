...
typedef enum
{
  ...
  DMA_EVENT_ME_SOURCE_ERROR           = 64,
  DMA_EVENT_ME_DESTINATION_ERROR      = 128,
  DMA_EVENT_ME_SPB_ERROR              = 256,
  DMA_EVENT_ME_SRI_ERROR              = 512,
  DMA_EVENT_ME_RAM_ERROR              = 1024,
  DMA_EVENT_ME_SAFE_LINKEDLIST_ERROR  = 2048,
  DMA_EVENT_ME_DMA_LINKEDLIST_ERROR   = 4096
} Dma_EventsType;
