...
#if (defined _TEXAS_INSTRUMENTS_C_CORTEXM_) /* to prevent double definition */
#error _TEXAS_INSTRUMENTS_C_CORTEXM_ already defined
#endif /* if (defined _TEXAS_INSTRUMENTS_C_CORTEXM_) */

/** \brief compiler symbol for Gnu compiler for CORTEXM */
/* Deviation MISRAC2012-1 */
#define _TEXAS_INSTRUMENTS_C_CORTEXM_ 1U
