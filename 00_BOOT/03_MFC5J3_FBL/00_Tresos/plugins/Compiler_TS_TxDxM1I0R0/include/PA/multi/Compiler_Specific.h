 ...
 * The macro _GREENHILLS_C_PPC_ is only used for Autosar 2.1 backward compatibility.
 */
/* COMPILER010 */
/* !LINKSTO CompilerAbstraction.ASR403.COMPILER010, 1 */
#if (defined _GREENHILLS_C_PA_) /* to prevent double definition */
#error _GREENHILLS_C_PA_ already defined
#endif /* if (defined _GREENHILLS_C_PA_) */

/** \brief compiler symbol for Greenhills compiler for PowerPC */
/* Deviation MISRAC2012-1 */
#define _GREENHILLS_C_PA_ 1U
