...
CC_INCLUDE_PATH      += \
   $(Compiler_CORE_PATH)/include/$(TARGET) \
   $(Compiler_CORE_PATH)/include/$(TARGET)\$(TOOLCHAIN)
...
ifeq ($(wildcard $(subst \,/,$(CC))),)
  $(error FILE DOES NOT EXIST CC $(CC))
endif
ifeq ($(wildcard $(subst \,/,$(CCLIB))),)
  $(error FILE DOES NOT EXIST CCLIB $(CCLIB))
endif
ifeq ($(wildcard $(subst \,/,$(LINK))),)
  $(error FILE DOES NOT EXIST LINK $(LINK))
endif
ifeq ($(wildcard $(subst \,/,$(COMPILER_DIR))),)
