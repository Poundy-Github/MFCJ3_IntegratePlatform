    ...
    if(ullength > 4U)
    {
       ...
       if(uwDataType == PROG_DATATYPE_SIGNED)
       {
...
#endif
        {
            ...
            eProgStatus=PROG_CheckCompleteHeader(&pubdata[2], (ullength-2));
    ...
    switch(uwDataType)
    {
        case PROG_DATATYPE_SIGNED:
 ...
 #endif
            {
                ...
                eProgStatus=PROG_CheckCompleteHeader(&m_stDiagMessageInfo.pubData[4], (m_stDiagMessageInfo.ulLength-4));
...
void PROG_HSMUpdate_TD(void)
{
    ...
    {
       /*Copy the all Decompressed data from TD request to HSM Buffer*/
       m_ulHsmbufferlength = m_stDiagMessageInfo.ulLength-2;
