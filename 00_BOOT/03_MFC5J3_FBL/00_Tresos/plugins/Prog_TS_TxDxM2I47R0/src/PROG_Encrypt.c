...
void PROG_GetSymDecryptionKey(Csm_SymKeyType* pstDecryptionKey)
{
    ...
    {
        pstDecryptionKey->data[ulIdx]  = (u32)            paubKeyData[((u16)((u16)ulDecryptionKeyLength - 1U) - ((u16)ulIdx*4U))];
        pstDecryptionKey->data[ulIdx] |= (u32)((u32)((u32)paubKeyData[((u16)((u16)ulDecryptionKeyLength - 2U) - ((u16)ulIdx*4U))] << 8U)  & 0x0000FF00U);
        pstDecryptionKey->data[ulIdx] |= (u32)((u32)((u32)paubKeyData[((u16)((u16)ulDecryptionKeyLength - 3U) - ((u16)ulIdx*4U))] << 16U) & 0x00FF0000U);
        pstDecryptionKey->data[ulIdx] |= (u32)((u32)((u32)paubKeyData[((u16)((u16)ulDecryptionKeyLength - 4U) - ((u16)ulIdx*4U))] << 24U) & 0xFF000000U);
    }
#endif
