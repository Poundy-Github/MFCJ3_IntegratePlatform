...
*/
                ...
                if ((ubCrcCvnLength == PROG_CRC32_LENGTH) && (m_stDiagMessageInfo.ulLength == ((PduLengthType)PROG_PARTIAL_SW_ROUTINE_CRC_LEN + ubTempBlockIdLen - 1U)))
                {
...
/* CHECK: PARSE */
                ...
                else if ((ubCrcCvnLength == PROG_CVN_LENGTH) && (m_stDiagMessageInfo.ulLength == ((PduLengthType)PROG_PARTIAL_SW_ROUTINE_CVN_LEN + ubTempBlockIdLen - 1U)))
                {
                ...
                else
                {
                    ...
                    UDS_LongRequestEnd(m_stDiagMessageInfo.ulLength, m_stDiagMessageInfo.pubTxData, UDS_NRC_13);
