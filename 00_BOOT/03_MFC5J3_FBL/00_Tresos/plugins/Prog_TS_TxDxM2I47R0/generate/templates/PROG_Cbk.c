 ...
 **/
tProgBoolean m_aubBlockDownloadStatus[PROG_SEGMENT_NB];
[!ENDIF!]
/*=============================== IMPLEMENTATION ================================*/
/*                                                                               */
...
[!IF "(node:exists(as:modconf('ProgVAG'))) or (node:exists(as:modconf('ProgDAG'))) or (node:exists(as:modconf('ProgJLR')) 
		and (as:modconf('ProgJLR')/General/PROG_JLR_VARIANT='PBL')) or (node:exists(as:modconf('ProgFord')) and
			as:modconf('ProgFord')/General/PROG_FORD_VARIANT='PBL') or (as:modconf('Prog')/General/Transmit_Response_Before_Reset = 'false')"!]
 ...
 **/
tProgStatus PROG_CustomHsmUpdateBlock(u16 uwBlockId, u8 *pubMemoryAddress, u32 ulMemorySize)
{
 ...
 **
 **/
tProgStatus PROG_CustomVDStable_update(tVDSlayout * pstVDSlayout,u8 * pubSegmentId, u8 ubVDSaccesstype)
{
	tProgStatus eStatus;
