...
#if ( ((PROG_IMPL_VARIANT == PROG_IMPL_10) || (PROG_IMPL_VARIANT == PROG_IMPL_20) || (PROG_IMPL_VARIANT == PROG_IMPL_40) || (PROG_IMPL_VARIANT == PROG_IMPL_60) || (PROG_IMPL_VARIANT == PROG_IMPL_90)) && (PROG_RESPOND_TO_PROG_SESSION == STD_ON))
...
#if (((PROG_IMPL_VARIANT == PROG_IMPL_10) || (PROG_IMPL_VARIANT == PROG_IMPL_20) || (PROG_IMPL_VARIANT == PROG_IMPL_30) || (PROG_IMPL_VARIANT == PROG_IMPL_40) || (PROG_IMPL_VARIANT == PROG_IMPL_60) || (PROG_IMPL_VARIANT == PROG_IMPL_90)) && ((PROG_RESPOND_TO_PROG_SESSION == STD_ON)))
...
#if ((PROG_RESET_CAUSE_ENABLE == STD_ON) || ((PROG_IMPL_VARIANT == PROG_IMPL_3) && \
