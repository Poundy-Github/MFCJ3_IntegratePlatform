...
#if (FLS_17_DMU_SW_MAJOR_VERSION != 10U)
#error "FLS_17_DMU_SW_MAJOR_VERSION does not match."
#endif

#if (FLS_17_DMU_SW_MINOR_VERSION != 30U)
#error "FLS_17_DMU_SW_MINOR_VERSION does not match."
#endif

#if (FLS_17_DMU_SW_PATCH_VERSION != 1U)
...
/*[cover parentID={6C63C328-5CB0-4efe-A474-EB350526D552}][/cover]*/
{
...

  {
    ...
    if(Fls_lChkOperError() == 0U)
    {
      ...
      #if (FLS_17_DMU_DEV_ERROR_DETECT == STD_ON) || \
      (FLS_17_DMU_SAFETY_ENABLE == STD_ON)
      /* [cover parentID={F2473319-D066-4023-85F4-A3FC3BCFDA36}]
      Is the number of sectors is 64 ?
      [/cover] */
      if((StatePtr->FlsEraseNumSectors & FLS_MOD64_MASK) == 0U)
      {
        /* Calculate the number of erase command cycles required*/
        /* [cover parentID={540D76FA-D600-4bfd-9072-4428C50EA193}]
        Is the number of sectors is 64 ?
        [/cover] */
      ...
      {
        /* Calculate the number of erase command cycles required*/
        /* [cover parentID={9A29800B-2D04-4920-99DC-4ED3DC92EC24}]
        [/cover] */
        TimeoutCal = (uint8)
     ...
     #if (FLS_17_DMU_DEV_ERROR_DETECT == STD_ON) || \
      (FLS_17_DMU_SAFETY_ENABLE == STD_ON)
      /* [cover parentID={7D7FE9EC-E0A1-46e0-8057-2270DA980988}]
       [/cover] */
      if (StatePtr->FlsTimeoutControl != 0U)
      {
        /* Update Timeout count for erase */
        /* [cover parentID={949E0C16-87F2-4ce6-B7BA-4ABF68634B1E}]
        [/cover] */
      ...
      if(Fls_lHWBusyCheck() == 0U)
      {
        ...
        else if (StatePtr->FlsTimeoutErr == FLS_17_DMU_ERASE)
        {
          /* Report Runtime error*/
          /* [cover parentID={9CB1C431-D13A-4394-B485-B935377A22CA}]
          Report erase failed runtime error
          [/cover] */
          #if (FLS_17_DMU_RUNTIME_ERROR_DETECT == STD_ON)
           Det_ReportRuntimeError( (uint16)FLS_17_DMU_MODULE_ID,
                                          FLS_17_DMU_INSTANCE_ID,
  ...
  #endif
  {
    ...
    if(Fls_lChkOperError() == 0U)
    {
      ...
      if(Fls_lHWBusyCheck() == 0U)
      {
        ...
        #if (FLS_17_DMU_DEV_ERROR_DETECT == STD_ON) || \
        (FLS_17_DMU_SAFETY_ENABLE == STD_ON)
        /* [cover parentID={4FBD1950-DAFF-4817-821A-B34BB1FFE4A1}]
         Is timeout control is enabled ?
        [/cover] */
        if (StatePtr->FlsTimeoutControl != 0U)
        {

          /* [cover parentID={2933FCC2-726B-48e2-8DEF-1BC847021FDE}]
          Is timeout control is enabled ?
          [/cover] */
  ...
  if (ErrorUninitFlag == 0U)
  #endif
    {
      ...
      if( JobType != FLS_17_DMU_NONE)
      {
        ...
        Is harwdare idle?
        [/cover] */
        /* [cover parentID={F7DC1B41-F82C-40bd-BFF2-43B048163996}]
        [/cover] */
  ...
  #endif
  {
    ...
    if(JobType == FLS_17_DMU_NONE)
    {
      ...
      do
      {
        ...
        /* [cover parentID={C1C1033B-4A2C-40b4-99F6-28C6BAD51D10}]
              loop to compare
              [/cover] */
        ...
        else
        {
          ...
          /* [cover parentID={510FDAA8-3E44-40db-A6B0-A5A474F492B8}]
          [/cover] */
...
/*[cover parentID={478A22CE-6897-4722-81AB-41264DBC1353}][/cover]*/
{
  ...
  else if(DMU_HF_SUSPEND.B.SPND == 1U)
  {
      ...
      Is Sequencial / protection error detected?
      [/cover] */
...
/* [cover parentID={E21C9DB9-FFE7-4807-9088-185BCAEBE945}][/cover] */
{
  ...
  #if (FLS_17_DMU_DEV_ERROR_DETECT == STD_ON) || \
  (FLS_17_DMU_SAFETY_ENABLE == STD_ON)
  /* [cover parentID={20BF9CDE-3C99-4150-8C7B-C552E6F145BA}]
  Is the parameter vlaue greater than 1 ?
  [/cover] */
  if(Param > ((uint8)0x01))
  {
    #if (FLS_17_DMU_SAFETY_ENABLE == STD_ON)
    /* [cover parentID={841C009A-0605-4ce9-BEFB-E80503604123}]
    [/cover] */
    Mcal_ReportSafetyError(FLS_17_DMU_MODULE_ID, FLS_17_DMU_INSTANCE_ID,
...
[/cover] */
{
  ...
  #endif
  {
    ...
    TimeOutCountInitial = Mcal_DelayGetTick();
    /* [cover parentID={AA80723E-C963-4a89-B9FE-034669C73AA2}]
     [/cover] */
    do
    {
      MeasuredTicks = Mcal_DelayGetTick() -  TimeOutCountInitial;
    OperStatusChk = ((uint32)DMU_HF_ERRSR.U & FLS_OPER_ERROR);
      /* [cover parentID={478EF9AB-3539-4c7c-AE8A-E64B6180C43C}]
      Is the HW busy ?
      [/cover] */
...
[/cover] */
{
  ...
  #if ( FLS_17_DMU_DEV_ERROR_DETECT == STD_ON )|| \
  (FLS_17_DMU_SAFETY_ENABLE == STD_ON)
  /* [cover parentID={C2DEDE9D-DA80-4825-8DF0-15D666B1604A}]
  ...
  else if(StatePtr->FlsEver != FLS_EVER_CHK)
  {
    ...
    if (DMU_HF_ERRSR.B.EVER != 0U)
    {
      /* [cover parentID={C5713918-B847-4c0b-B964-DB1EE2F55D3A}]
          [/cover] */
  ...
  /* Check if there is verify error during Erase operation */
  /* [cover parentID={E16E26B3-432F-48a4-A0B8-5BAE8F9F4187}]
  Is EVER error present ?
  [/cover] */
  if(DMU_HF_ERRSR.B.EVER == 0U)
  {
    ...
    {
      #if (FLS_17_DMU_RUNTIME_ERROR_DETECT == STD_ON)
      /* [cover parentID={F96317E0-6084-47d1-9814-6F9FA135F32A}]
      [/cover] */
      Det_ReportRuntimeError( (uint16)FLS_17_DMU_MODULE_ID,
                              FLS_17_DMU_INSTANCE_ID,
                              FLS_17_DMU_SID_MAIN,
      ...
      StatePtr->FlsEver = (uint8)0x00;
      #endif
      /* [cover parentID={A9ABB334-54A0-49a6-B6EC-FC17604A7A08}]
        [/cover] */
      RetVal = E_NOT_OK; /*return from function*/
    }
  ...
  else /*EVER error*/
  {
    ...
    [/cover] */
    /* [cover parentID={C1F67AFE-EB25-477e-8A80-3E378D72AB87}]
      Is the EVER Flag set ?
    [/cover] */
    if(StatePtr->FlsEver == ((uint8)0x00))
    {
      /* [cover parentID={EB5C2188-ACB3-4c79-974C-10C78C187C09}]
          [/cover] */
      StatePtr->FlsEver = FLS_EVER_CHK;
    ...
    if(StatePtr->FlsEver == ((uint8)0x00))
    {
      ...
      /* [cover parentID={2CF252A9-99C5-4e92-8042-09C1F99C0BBE}]
          [/cover] */
      StatePtr->FlsEver = FLS_EVER_CHK;
      RetVal = E_NOT_OK;
    }
    else
    {
      ...
      /* [cover parentID={2B375516-EAAB-4a27-9111-1CC274FD101D}]
                          [/cover] */
      Fls_lErrorHandler(FLS_17_DMU_ERASE);
  ...
  /* [cover parentID={9C869C68-F488-4cb9-BF8D-B95FE9479333}]
  [/cover] */
  if(RetVal == E_OK)
  {
    ...
    else /* Job completed successfully */
    {
      ...
      else
      {
        ...
        /*Fls_lEverFlagChkFail*/
        /* [cover parentID={23C4ED11-CE8F-4100-B283-050D462FC8C9}]
                1) Clear EVER error
...
*******************************************************************************/
static void Fls_lMainRead(void)
/* [cover parentID={670FE048-1291-4797-861C-5E8DB053378B}]
Fls_lMainRead
[/cover] */
{
  Fls_17_Dmu_StateType       *StatePtr;
  ...
  do
  {
    ...
    If the no. of bytes to be read >= Word size AND Source and buffer
    ...
    {
      /* [cover parentID={92B9D092-B214-4281-BA97-01D7A12EA05C}]
       [/cover] */
    ...
    Number of bytes to be read remaining ?
    [/cover] */
  } while(((ReadCount)) > 0U);
...
static void Fls_lMainCompare(void)
{
  ...
  do
  {
    ...
    Is the read address, read buffer word aligned and number of bytes to be
    read >= word size
    [/cover] */
      ...
      )
    {
      ...
      /*MISRA2012_RULE_11_3_JUSTIFICATION: Pointer cast is required to match
       the object types as the address of the register is being passed.*/
      /* [cover parentID={D019B580-B3C1-4e2c-B839-4DA988CF7B56}]
      Is the readbuffer value same as the one read from the read address ?
      [/cover] */
      ...
      {
        /* [cover parentID={BC13F7B7-7C25-4f9c-B956-52E2586F2A29}]
            [/cover] */
        /* MISRA2012_RULE_18_4_JUSTIFICATION: Pointer arithmetic other than
        array indexing used for FLASH address calculation and for subsequent
        traversal.The access range is within the flash address range.*/
    ...
    else
    {
      ...
      /* [cover parentID={9C28E116-EBA1-4c44-8730-9511A389F7FF}]
      Is the read buffer value same as the one read from the read address ?
      [/cover] */
      ...
      {
        /* [cover parentID={D5B66F00-97A2-4fd8-827B-FFF663923493}]
        [/cover] */
        StatePtr->FlsReadBufferPtr++;
        SourcePtr++;
        ReadCount--;
...
[/cover] */
{
  ...
  do
  {
    ...
    Check if the source address is word aligned AND Read count is > word  size
    [/cover] */
    if((((uint32)SourcePtr & (FLS_WORD_SIZE - 1U)) == 0U) &&
        (ReadCount >= FLS_WORD_SIZE))
    {
      ...
      else
      {
        ...
        traversal.The access range is within the flash address range.
        */
        /* [cover parentID={C562C81E-831D-4235-96F6-7F94D06665CE}]
          [/cover] */
        SourcePtr += FLS_WORD_SIZE;
        ReadCount -= FLS_WORD_SIZE;
      }
    ...
    else
    {
      ...
      /* [cover parentID={1F141416-3F07-4ef1-BC3C-A61FB9F69B74}]
      [/cover] */
      ...
      {
        /* [cover parentID={6B98C660-8FB4-4a4b-A278-E999E1C57493}]
        [/cover]
        */
        SourcePtr++;
        ReadCount--;
...
[/cover] */
{
  ...
  else
  {
    ...
    {
      /* [cover parentID={54129637-6022-419e-893F-D5021B5B8380}]
      [/cover] */
      PageLength = FLS_17_DMU_PAGE_SIZE;
    }
    else
    {
      /* [cover parentID={F8895D09-A5B5-46ec-A13A-F88BC5B3B408}]
          [/cover] */
...
static void Fls_lMainWriteJobStart(const uint32 PhysicalAddress)
{
  ...
  If command cycle timeout error is detected?
  [/cover] */
  else if (StatePtr->FlsTimeoutErr == FLS_17_DMU_WRITE)
  {
    #if (FLS_17_DMU_RUNTIME_ERROR_DETECT == STD_ON)
...
static uint8 Fls_lTimeOutDET(const uint8 ServiceID)
{
  ...
  /* [cover parentID={D855D954-377C-445d-9C44-3C9474690494}]
  Is timeout detection enabled i.e. (is FlsTimeoutControl not 0)?
  [/cover] */
  if (StatePtr->FlsTimeoutControl != 0U)
  {
    ...
    if(StatePtr->JobStarted.Erase != 0U)
    {
      ...
      {
        /* [cover parentID={CE40EF21-3A4C-4b0e-8E87-F969A86FC905}]
           [/cover] */
        StatePtr->FlsEraseTimeoutCycleCount--;
      }
    }
...
LOCAL_INLINE boolean Fls_lCheckWrittenPage(const uint32 PageLength)
{
  ...
  do
  {
    ...
    {
      /* [cover parentID={7E5B111D-E11D-4978-93E7-486C91D9AC88}]
      [/cover] */
      Count++;
  ...
  /* [cover parentID={8DCC9468-BFFD-4816-8278-37F94B071519}]
  Is the length over?
  [/cover] */
  while(Count < (PageLength / FLS_WORD_SIZE));
  /* [cover parentID={7DBAD0FF-DF65-4e36-9EF6-60AFF4E1FD89}]
  [/cover] */
  if(Error == (boolean)FALSE)
  {
    /* Check for Non-correctable ECC errors during the above check */
    /* [cover parentID={8A534A68-E3EE-4d70-B2F1-7C4A09284503}]
    Is uncorrectable bit error detected?
    [/cover] */
    if(Fls_lChkBitErrors() != 0U)
    {
      /* Report to DET */
      #if (FLS_17_DMU_DEV_ERROR_DETECT == STD_ON) || \
      (FLS_17_DMU_SAFETY_ENABLE == STD_ON)
      /* [cover parentID={3D9E28F1-A4FC-4564-B97D-35FA825E4118}]
      Report DET error
      [/cover] */
      Fls_lReportError(FLS_17_DMU_SID_MAIN,
...
LOCAL_INLINE void Fls_lCalculateWriteTimeoutCount(void)
{
  ...
  /* [cover parentID={DC553918-D49F-4f6c-8F9A-BA8C8E0DD908}]
  Is the value of length greater than the PAGE Length ?
  [/cover] */
  if(Length > FLS_17_DMU_PAGE_SIZE)
  {
    /*If the write address is aligned to burst size of 32 and length is less
     than burst size*/
    /* [cover parentID={BB2AF272-E89D-4011-B057-AA254CB36919}]
    Is the write address burst aligned and length size is between page size
    and burst write size ?
    [/cover] */
    if(((PageStartAddress & (FLS_17_DMU_BURST_PAGE_SIZE - 1U)) != 0U)
        || (Length <= (FLS_17_DMU_BURST_PAGE_SIZE - FLS_17_DMU_PAGE_SIZE)))
    {
      /* [cover parentID={48C4AE2E-3544-49bf-A274-FEE2AE507A3E}]
          [/cover] */
      PageWriteCount =  (Length >> FLS_17_DMU_PAGE_SHIFT);

      /*Only page writes are there*/
      TotalWriteCycles  = PageWriteCount;
    }
    else /*Use page if not a multiple of burst*/
    {
      /* [cover parentID={C523703D-C988-4221-934A-A5972050B028}]
          [/cover] */
      /*Calculate the number of burst cycles needed*/
      BurstCount = Length >> FLS_17_DMU_BURST_PAGE_SHIFT;

      /*The remainder will be written page wise*/
  ...
  /* [cover parentID={53BED2FB-F2EB-4dca-82E6-8C7B70C1F6EB}]
             [/cover] */
    ...
    const uint8 ServiceID)
{
  ...
  do
  {
    ...
    If the address erased correctly ?
    [/cover] */
    if((*(AddrCheckPtr + IndexAddrCheckPtr)) == 0U)
    {
      /* [cover parentID={B8959440-7821-4f82-A993-DD85BC06D8F2}]
      [/cover] */
      Loop++;
      IndexAddrCheckPtr++;
    }
    else
    {
      ...
      Reprt DET error
      [/cover] */
    /* [cover parentID={AA2584EF-BA3C-44d2-A181-1597C23D5A0F}]
    [/cover] */
      Fls_lReportError(ServiceID,
  ...
  /* [cover parentID={24EE979D-49F5-46e4-AFEB-7D034451F5CB}]
    [/cover] */
  if(RetVal == E_OK)
  {
    /* Check for Non-correctable ECC errors during the above check */
...
static void Fls_lReportError(const uint8 Fls_Sid, const uint8 ErrorId)
{
  /*[cover parentID={F1ED8B26-E992-4f34-A2D8-FC1B986BA9AB}]
  [/cover] */
  #if (FLS_17_DMU_DEV_ERROR_DETECT == STD_ON)
