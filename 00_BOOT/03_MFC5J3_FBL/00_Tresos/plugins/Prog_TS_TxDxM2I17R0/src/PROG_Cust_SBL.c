...
#define PROG_SBL_HEADER_STOP_SEC_CONST_8
#include <MemMap.h>
#if  ((PROG_IMPL_VARIANT == PROG_IMPL_3) || (PROG_IMPL_VARIANT == PROG_IMPL_10))
...
void PROG_JumpToSBL(void)
{
    ...
    /*Get SBLaddress*/
    ulAddressSBL = PROG_RetrieveRequestData32(4U);
    /* Deviation MISRAC2012-1 */
...
NCS_PRI_FCT void PROG_TransmitActiveSBLResponse(void)
{
  ...
  (void)EB_Send_TPFrame(uwLen, m_aubActivateRoutineResponse);
#endif
...
#endif /* ((PROG_IMPL_VARIANT == PROG_IMPL_3) || (PROG_IMPL_VARIANT == PROG_IMPL_10)) */
        }
        else
        {
            eProgStatus = PROG_E_NOT_OK;
