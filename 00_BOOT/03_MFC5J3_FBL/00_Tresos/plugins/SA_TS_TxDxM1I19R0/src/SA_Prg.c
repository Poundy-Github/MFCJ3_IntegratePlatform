 ...
 *
 *   Reason:
 * The Crypto keys are updated, for dealing with memory alignment
 *
 *
 ...
 *
 *   Reason:
 * The function parameters are not used under certain encapsulations
 *
 */
/*=============================== FILE INCLUSION ================================*/
/*                                                                               */
...
NCS_PRI_VAR u32 m_ulSA2waitTime;
...
void SA_InitCrypto(void)
{
    ...
    u8 aubSAReqRes[SA1_MSGREQ_SIZE];
#endif
#endif
