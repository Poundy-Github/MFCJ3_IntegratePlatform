...
#include <MemMap.h>
NCS_PRI_VAR u8 m_ubAesBlockIndex;
NCS_PRI_VAR u8 m_ubAESCTR_Blockcount;
NCS_PRI_VAR u8 m_aubMacValue[SA_MACSIZE];
NCS_PRI_VAR u8 m_aubAesCtrClientRndNum[SA_CLIENT_RNDNUM_SIZE];
NCS_PRI_VAR u8 m_aubAesCtrServerRndNum[SA_SERVER_RNDNUM_SIZE];
NCS_PRI_VAR tSA_AuthenticationState m_ulAuthentication0001State;
NCS_PRI_VAR u8 m_aubIV_Aligned16[SA_AESCTR_IVLEN];
NCS_PRI_VAR u8 m_aubSaAm0001BufAligned16[SA_AM0001_MAXBUF];
#define SA_AM0001_STOP_SEC_VAR_INIT_16
#include <MemMap.h>
NCS_PRI_VAR tSaStatus m_ubSaStatus;
NCS_PRI_VAR Csm_ReturnType m_ubCsmStatus;
NCS_PRI_VAR tSA_ConcatenatePar m_aubConcatenatedataptr[2U];
...
NCS_PRI_FCT void SA_SeedGen_EncryptServerPoo(void)
{
    ...
    m_ubAESCTR_Blockcount = m_ubAESCTR_Blockcount + 1;
#endif
...
NCS_PRI_FCT void SA_SeedGen_MsgAuthCode(void)
{
    ...
    m_pubSAReqResptr[2U] = (((SA1_RESPONSE_MSGID) & 0xFF00U) >> 8U);
